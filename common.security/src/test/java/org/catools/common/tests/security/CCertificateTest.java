...
public class CCertificateTest extends CBaseUnitTest {
  ...
  public CCertificateTest() {
    ...
    VALID_FROM_FILE =
        new CCertificate(
            VALID_RESOURCCE.saveToFolder(CPathConfigs.getTempFolder()).get(0).getCanonicalPath());
    INVALID_FROM_FILE =
        new CCertificate(
            INVALID_RESOURCCE.saveToFolder(CPathConfigs.getTempFolder()).get(0).getCanonicalPath());
  }
  ...
  public void testToSSLContext() {
    ...
    verify.Object.isNotNull(sslContext, "SSLContext has been generated");
  }
