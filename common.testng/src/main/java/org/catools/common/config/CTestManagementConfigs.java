...
/**
 * Utility class providing configuration access for Test Management System (TMS) settings.
 * This class retrieves configuration values from HOCON configuration files for TMS integration.
 * 
 * <p>Configuration properties are accessed through predefined paths:
 * <ul>
 *   <li>catools.tms.project_name - The name of the project in TMS</li>
 *   <li>catools.tms.version_name - The version name for the project</li>
 *   <li>catools.tms.url_format_to_test - URL format template for linking to tests</li>
 *   <li>catools.tms.url_format_to_defect - URL format template for linking to defects</li>
 * </ul>
 * 
...
public class CTestManagementConfigs {
   ...
   * 
   * <p>This method reads the project name from the configuration property 
   * {@code catools.tms.project_name}. The project name is typically used
   * to identify the project within the Test Management System.
   * 
   * <p>Example usage:
   * <pre>
   ...
   * 
   * <p>This method reads the version name from the configuration property 
   * {@code catools.tms.version_name}. The version name is used to identify
   * the specific version or release of the project being tested.
   * 
   * <p>Example usage:
   * <pre>
   ...
   * 
   * <p>This method reads the URL format from the configuration property 
   * {@code catools.tms.url_format_to_test}. The returned string is a template
   * that can be used with {@link #getUrlToTest(String)} to generate specific
   * test URLs by substituting placeholders.
   * 
   * <p>Example usage:
   * <pre>
   ...
   * 
   * <p>This method takes the URL format template from {@link #getUrlToTest()}
   * and substitutes the provided test key into the placeholder positions.
   * The formatting is performed using {@link CStringUtil#format(String, Object...)}.
   * 
   ...
   * @return the formatted URL for the specific test, or empty string if URL format is not configured
   * @see #getUrlToTest()
   */
   ...
   * 
   * <p>This method reads the URL format from the configuration property 
   * {@code catools.tms.url_format_to_defect}. The returned string is a template
   * that can be used with {@link #getUrlToDefect(String)} to generate specific
   * defect URLs by substituting placeholders.
   * 
   * <p>Example usage:
   * <pre>
   ...
   * 
   * <p>This method takes the URL format template from {@link #getUrlToDefect()}
   * and substitutes the provided defect key into the placeholder positions.
   * The formatting is performed using {@link CStringUtil#format(String, Object...)}.
   * 
   * <p>If the URL format is not configured or is blank, an empty string is returned.
   * 
   ...
   * @return the formatted URL for the specific defect, or empty string if URL format is not configured
   * @see #getUrlToDefect()
   */
