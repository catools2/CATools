 ...
 * along with performance metrics and timing information.
 * 
 * <p>This class is used to track user actions that result in page transitions or state changes,
 * such as navigation, form submissions, or AJAX requests. It provides a comprehensive view of
 * the transition including page information, performance metrics, and execution timing.</p>
 * 
 * <p>Example usage:</p>
 * <pre>{@code
...
public class CWebPageTransitionInfo {
  /**
   * The name or description of the action that caused the page transition.
   * Examples: "NavigateToHomePage", "SubmitLoginForm", "ClickSearchButton"
   */
  private String actionName;
  
  /**
   * Information about the page state before the action was performed.
   * Contains the page title and URL before the transition.
   */
  private CWebPageInfo pageBeforeAction;
  
  /**
   * Information about the page state after the action was performed.
   * Contains the page title and URL after the transition.
   */
  private CWebPageInfo pageAfterAction;
  
  /**
   * Performance metrics collected during the page transition.
   * Common metrics include loading times, render times, and resource usage.
   */
   ...
   * 
   * <p>This constructor is used when you want to track a simple page transition without
   * performance metrics or specific timing information.</p>
   * 
  ...
  /**
   * Creates a new page transition info with comprehensive information including performance metrics and timing.
   * 
   * <p>This constructor is used when you want to capture detailed performance information
   * about a page transition, including metrics like load times, paint times, and other
   * performance indicators collected from the browser's DevTools.</p>
   * 
   * @param actionName the descriptive name of the action performed
   * @param pageBeforeAction the page information before the action
   * @param pageAfterAction the page information after the action
   ...
   * 
   * <p>This method provides safe access to the page title from the 'before' state,
   * returning null if no page information was captured before the action.</p>
   * 
   ...
   * 
   * <p>This method provides safe access to the page URL from the 'before' state,
   * returning null if no page information was captured before the action.</p>
   * 
   ...
   * 
   * <p>This method provides safe access to the page title from the 'after' state,
   * returning null if no page information was captured after the action.</p>
   * 
   ...
   * 
   * <p>This method provides safe access to the page URL from the 'after' state,
   * returning null if no page information was captured after the action.</p>
   * 
