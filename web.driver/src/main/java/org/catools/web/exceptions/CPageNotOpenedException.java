...
/**
 * Exception thrown when a page is expected to be open but is not found or accessible.
 * This exception provides detailed information about the current page state including
 * the page title and URL at the time the exception was thrown.
 * 
 * <p>This exception is typically thrown when:
 * <ul>
 *   <li>A page fails to load completely</li>
 *   <li>Navigation to a page was unsuccessful</li>
 *   <li>A page is not in the expected state for further operations</li>
 *   <li>Page elements are not available due to page loading issues</li>
 * </ul>
 * 
...
public class CPageNotOpenedException extends RuntimeException {
  ...
  /**
   * Constructs a new CPageNotOpenedException with detailed information about the current page state.
   * The exception message includes the current page title and URL from the provided driver.
   * 
   ...
   * }</pre>
   * 
   * <p><strong>Another example with timeout scenarios:</strong></p>
   * <pre>{@code
