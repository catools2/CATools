...
public class CKubeUtil {
  ...
  public static CKubePods getNamespacePods(CoreV1Api api, String namespace) {
    return getNamespacePods(
        api, namespace, null, null, null, null, null, null, null, null, null, null);
  }
   ...
   */
  public static CKubePods getNamespacePods(
      CoreV1Api api,
      String namespace,
      String pretty,
  ...
  private static CKubeContainers readContainers(List<V1ContainerStatus> containers) {
    ...
    for (V1ContainerStatus status : containers) {
      ...
      if (status.getState() != null) readContainerStates(kubeContainer, status.getState());
  ...
  private static void readContainerStates(
      CKubeContainer kubeContainer, V1ContainerState containerState) {
