...
public class McpStreamableServerInfo extends McpServerInfo {
    ...
    /**
     * The extractor to extract the transport storage from the HTTP request.
     */
    ...
    /**
     * Returns the extractor to extract the transport storage from the HTTP request.
     *
     * @return the extractor to extract the transport storage from the HTTP request
     */
     ...
     */
    public static class Builder extends McpServerInfo.Builder<Builder> {
        ...
        /**
         * The extractor to extract the transport storage from the HTTP request. Default value is {@code
        ...
        /**
         * Sets the extractor to extract the transport storage from the HTTP request.
         *
         * @param contextExtractor the extractor to extract the transport storage from the HTTP request
         * @return the self reference of the builder
         */
