...
@Slf4j
@UtilityClass
public final class McpReflections {
    /**
    ...
    public void addReflections(Set<Reflections> reflections) {
        McpReflections.reflections.addAll(reflections);
    }
     ...
     */
    private Set<String> determineBasePackage(Class<?> mainClass, McpServerApplication application) {
        if (application != null) {
