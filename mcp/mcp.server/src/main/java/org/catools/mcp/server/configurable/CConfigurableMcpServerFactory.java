...
/**
 * This factory class is used to create instances of {@link CConfigurableMcpServer} implementations
 * based on the specified {@link CMcpServerConfiguration}.
 */
public final class CConfigurableMcpServerFactory {
  ...
  /**
   * Creates a new instance of {@link CConfigurableMcpServer} implementations based on the specified
   * {@link CMcpServerConfiguration}.
   *
