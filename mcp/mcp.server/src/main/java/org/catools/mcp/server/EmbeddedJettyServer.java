...
import org.catools.mcp.struct.NamedThread;
...
public class EmbeddedJettyServer {
    ...
    public EmbeddedJettyServer() {
        this.threadPool = Executors.newSingleThreadExecutor(new NamedThread("mcp-http-server"));
    }
