...
/**
 * This class is used to create a new instance of {@link BaseMcpStreamableServer} based on the specified
 * {@link McpStreamableServerInfo} in Streamable HTTP mode.
 */
public class BaseMcpStreamableServer extends BaseMcpServer<McpStreamableServerInfo> {
    /**
