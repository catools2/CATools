 ...
 *
 * <p>This class provides helper methods for managing WebDriver window properties such as size and
 * position. It is designed as a utility class with static methods to support common WebDriver setup
 * operations.
 *
...
public class CWebDriverUtil {
   ...
   *
   * <p>This method provides flexible window configuration options:
   *
   * <ul>
   *   <li>If {@code windowsPosition} is null, the window is positioned at (0,0)
   *   <li>If {@code windowsSize} is null, the window is maximized
   *   <li>If an exception occurs during configuration, the WebDriver is automatically closed
   * </ul>
   *
   ...
   * @throws RuntimeException if an error occurs during window configuration. The WebDriver will be
