...
/**
 * A web collection class that represents a list of web elements, providing convenient methods for
 * iterating, filtering, and performing operations on multiple similar web elements.
 *
 * <p>This class is designed to work with dynamic lists of web elements that may appear and
 * disappear during test execution. It provides robust waiting mechanisms and various utility
 * methods for common list operations.
 *
 * <p>Example usage:
 *
 * <pre>{@code
...
public class CWebList<E extends CWebElement> implements CWebIterable<E> {
  ...
  /**
   * Performs an action on the first element that matches the given condition. Uses default
   * timeouts.
   *
  ...
  /**
   * Performs an action on elements that match the given condition with custom timeout for first
   * element.
   *
   * @param condition the predicate to test each element against
   * @param action the action to perform on matching elements
  ...
  /**
   * Tests if ALL elements in the list satisfy the given predicate with custom timeout for first
   * element.
   *
   * @param predicate the condition to test each element against
   * @param firstWaitSecs timeout for the first element
  ...
  /**
   * Tests if ANY element in the list satisfies the given predicate with custom timeout for first
   * element.
   *
   * @param predicate the condition to test each element against
   * @param firstWaitSecs timeout for the first element
