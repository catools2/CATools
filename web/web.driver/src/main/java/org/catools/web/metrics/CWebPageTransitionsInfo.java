 ...
 *
 * <p>This class is particularly useful for web automation testing scenarios where you need to track
 * multiple page transitions, collect performance metrics, and analyze user navigation patterns
 * across different pages in a web application.
 *
 * <p>The class leverages Lombok's {@code @Data} annotation to automatically generate getter/setter
 * methods, equals(), hashCode(), and toString() methods.
 *
