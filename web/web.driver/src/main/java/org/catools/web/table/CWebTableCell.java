 ...
 *
 * <p>This record encapsulates the essential properties of a table cell including its position,
 * column header, content value, and visibility state. It provides an immutable representation of
 * web table cell data that can be used for parsing, validation, and manipulation of web-based
 * tabular data.
 *
 ...
 * @param header the column header name associated with this cell, may be null if no header is
 *     available
