 ...
 *
 * <p>Please Note that we should extend manually {@link CBooleanVerification} for each new added
 * verification here
 */
public interface CBooleanWaitVerify
    extends CObjectWaitVerify<Boolean, CBooleanState>, CBooleanVerify {
