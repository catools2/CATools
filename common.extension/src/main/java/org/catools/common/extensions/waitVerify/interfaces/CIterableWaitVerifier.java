...
public interface CIterableWaitVerifier<E> extends CIterableVerifier<E>, CObjectWaitVerifier<Iterable<E>, CIterableState<E>> {
  ...
  default void verifyContains(E expected, final int waitInSeconds, final int intervalInMilliSeconds, final String message, final Object... params) {
    _verify(expected, false, (a, e) -> CIterableUtil.contains(get(), e), waitInSeconds, intervalInMilliSeconds, message, params);
  }
   ...
   * @param waitInSeconds maximum wait time
   */
  default void verifyContainsAll(Iterable<E> expected, final int waitInSeconds) {
   ...
   * @param params        parameters in case if message is a format {@link String#format}
   */
  default void verifyContainsAll(Iterable<E> expected, final int waitInSeconds, final String message, final Object... params) {
   ...
   * @param intervalInMilliSeconds interval between retries in milliseconds
   */
  default void verifyContainsAll(Iterable<E> expected, final int waitInSeconds, final int intervalInMilliSeconds) {
   ...
   * @param params                 parameters in case if message is a format {@link String#format}
   */
  default void verifyContainsAll(Iterable<E> expected, final int waitInSeconds, final int intervalInMilliSeconds, final String message, final Object... params) {
   ...
   * @param waitInSeconds maximum wait time
   */
  default void verifyContainsNone(Iterable<E> expected, final int waitInSeconds) {
   ...
   * @param params        parameters in case if message is a format {@link String#format}
   */
  default void verifyContainsNone(Iterable<E> expected, final int waitInSeconds, final String message, final Object... params) {
   ...
   * @param intervalInMilliSeconds interval between retries in milliseconds
   */
  default void verifyContainsNone(Iterable<E> expected, final int waitInSeconds, final int intervalInMilliSeconds) {
   ...
   * @param params                 parameters in case if message is a format {@link String#format}
   */
  default void verifyContainsNone(Iterable<E> expected, final int waitInSeconds, final int intervalInMilliSeconds, final String message, final Object... params) {
    _verify(expected, false, (a, e) -> {
      CList<E> diff = new CList<>();
  ...
  default void verifyEmptyOrNotContains(E expected, final int waitInSeconds, final int intervalInMilliSeconds, final String message, final Object... params) {
    _verify(expected, false, (a, e) -> _toState(a).emptyOrNotContains(e), waitInSeconds, intervalInMilliSeconds, message, params);
  }
   ...
   * @param waitInSeconds maximum wait time
   */
  default void verifyEquals(Iterable<E> expected, final int waitInSeconds) {
   ...
   * @param params        parameters in case if message is a format {@link String#format}
   */
  default void verifyEquals(Iterable<E> expected, final int waitInSeconds, final String message, final Object... params) {
   ...
   * @param intervalInMilliSeconds interval between retries in milliseconds
   */
  default void verifyEquals(Iterable<E> expected, final int waitInSeconds, final int intervalInMilliSeconds) {
   ...
   * @param params                 parameters in case if message is a format {@link String#format}
   */
  default void verifyEquals(Iterable<E> expected, final int waitInSeconds, final int intervalInMilliSeconds, final String message, final Object... params) {
  ...
  default void verifyHas(Predicate<E> expected, final String message, final Object... params) {
    _verify(expected, false, (a, e) -> CIterableUtil.has(get(), e), message, params);
  }
  ...
  default void verifyHas(Predicate<E> expected, final int waitInSeconds, final int intervalInMilliSeconds, final String message, final Object... params) {
    _verify(expected, false, (a, e) -> CIterableUtil.has(get(), e), waitInSeconds, intervalInMilliSeconds, message, params);
  }
  ...
  default void verifyIsEmpty(final int waitInSeconds, final int intervalInMilliSeconds, final String message, final Object... params) {
    _verify(true, false, (a, e) -> CIterableUtil.isEmpty(get()), waitInSeconds, intervalInMilliSeconds, message, params);
  }
   ...
   * @param waitInSeconds maximum wait time
   */
  default void verifyNotContainsAll(Iterable<E> expected, final int waitInSeconds) {
   ...
   * @param params        parameters in case if message is a format {@link String#format}
   */
  default void verifyNotContainsAll(Iterable<E> expected, final int waitInSeconds, final String message, final Object... params) {
   ...
   * @param intervalInMilliSeconds interval between retries in milliseconds
   */
  default void verifyNotContainsAll(Iterable<E> expected, final int waitInSeconds, final int intervalInMilliSeconds) {
   ...
   * @param params                 parameters in case if message is a format {@link String#format}
   */
  default void verifyNotContainsAll(Iterable<E> expected, final int waitInSeconds, final int intervalInMilliSeconds, final String message, final Object... params) {
    _verify(expected, false, (a, e) -> _toState(a).notContainsAll(expected), waitInSeconds, intervalInMilliSeconds, message, params);
  }
}
