...
public interface CObjectWaitVerifier<O, S extends CObjectState<O>>
    extends CObjectVerifier<O, S>, CBaseVerify<O, S> {
  ...
  default void verifyEquals(
      final CVerificationQueue verifier, final O expected, final int waitInSeconds) {
  ...
  default void verifyEquals(
    ...
    verifyEquals(
        verifier, expected, waitInSeconds, intervalInMilliSeconds, getDefaultMessage("Are Equals"));
  }
