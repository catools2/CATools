...
public interface CBooleanVerifier extends CObjectVerifier<Boolean, CBooleanState> {
  ...
  default void verifyIsFalse(final String message, final Object... params) {
    _verify(false, false, (a, b) -> _toState(a).isFalse(), message, params);
  }
  ...
  default void verifyIsTrue(final String message, final Object... params) {
    _verify(true, false, (a, b) -> _toState(a).isTrue(), message, params);
  }
  ...
  default void verifyNotEquals(final Boolean expected, final String message, final Object... params) {
    _verify(expected, false, (a, b) -> _toState(a).notEquals(b), message, params);
  }
}
