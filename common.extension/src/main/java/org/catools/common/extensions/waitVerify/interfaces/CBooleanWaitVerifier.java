...
public interface CBooleanWaitVerifier extends CObjectWaitVerifier<Boolean, CBooleanState>, CBooleanVerifier {
  ...
  default void verifyIsFalse(final int waitInSeconds, final int intervalInMilliSeconds, final String message, final Object... params) {
    _verify(false, false, (a, b) -> a == b, waitInSeconds, intervalInMilliSeconds, message, params);
  }
  ...
  default void verifyIsTrue(final int waitInSeconds, final int intervalInMilliSeconds, final String message, final Object... params) {
    _verify(true, false, (a, b) -> a == b, waitInSeconds, intervalInMilliSeconds, message, params);
  }
}
