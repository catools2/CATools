...
public interface CObjectWaitVerifier<O, S extends CObjectState<O>> extends CObjectVerifier<O, S>, CBaseVerifier<O> {
  ...
  default void verifyEquals(final O expected, final int waitInSeconds, final int intervalInMilliSeconds, final String message, final Object... params) {
    _verify(expected, printDiff(expected), (o1, o2) -> _toState(o1).isEqual(o2), waitInSeconds, intervalInMilliSeconds, message, params);
  }
  ...
  default void verifyEqualsAny(List<O> expectedList, final int waitInSeconds, final int intervalInMilliSeconds, final String message, final Object... params) {
    _verify(expectedList, printDiff(expectedList), (a, b) -> a != null && b != null && new CList<>(b).has(b2 -> _toState(a).isEqual(b2)), waitInSeconds, intervalInMilliSeconds, message, params);
  }
  ...
  default void verifyEqualsNone(List<O> expectedList, final int waitInSeconds, final int intervalInMilliSeconds, final String message, final Object... params) {
    _verify(expectedList, printDiff(expectedList), (a, b) -> a != null && b != null && new CList<O>(b).hasNot(b2 -> _toState(a).isEqual(b2)), waitInSeconds, intervalInMilliSeconds, message, params);
  }
  ...
  default void verifyIsNotNull(final int waitInSeconds, final int intervalInMilliSeconds, final String message, final Object... params) {
    _verify(new Object(), false, (o1, o2) -> o1 != null, waitInSeconds, intervalInMilliSeconds, message, params);
  }
  ...
  default void verifyIsNull(final int waitInSeconds, final int intervalInMilliSeconds, final String message, final Object... params) {
    _verify(null, false, (o1, o2) -> _toState(o1).isEqual((O) o2), waitInSeconds, intervalInMilliSeconds, message, params);
  }
  ...
  default void verifyNotEquals(final O expected, final int waitInSeconds, final int intervalInMilliSeconds, final String message, final Object... params) {
    _verify(expected, printDiff(expected), (o1, o2) -> _toState(o1).notEquals(o2), waitInSeconds, intervalInMilliSeconds, message, params);
  }
}
