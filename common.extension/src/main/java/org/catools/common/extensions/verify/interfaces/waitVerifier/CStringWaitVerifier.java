...
public interface CStringWaitVerifier
  ...
  default void verifyCenterPadEquals(
      ...
      final int waitInSeconds) {
    verifyCenterPadEquals(
        verifier, size, padStr, expected, waitInSeconds, getDefaultWaitIntervalInMilliSeconds());
  }
   ...
   */
  default void verifyCompare(
      CVerificationQueue verifier, String stringToCompare, int expected, final int waitInSeconds) {
    verifyCompare(
        verifier, stringToCompare, expected, waitInSeconds, getDefaultWaitIntervalInMilliSeconds());
  }
  ...
  default void verifyContains(
      ...
      final Object... params) {
    verifyContains(
        verifier, expected, waitInSeconds, getDefaultWaitIntervalInMilliSeconds(), message, params);
  }
  ...
  default void verifyEndsWith(
      ...
      final Object... params) {
    verifyEndsWith(
        verifier, suffix, waitInSeconds, getDefaultWaitIntervalInMilliSeconds(), message, params);
  }
  ...
  default void verifyIsBlank(
      CVerificationQueue verifier, final int waitInSeconds, final int intervalInMilliSeconds) {
    verifyIsBlank(
        verifier, waitInSeconds, intervalInMilliSeconds, getDefaultMessage("Value Is Blank"));
  }
   ...
   */
  default void verifyIsBlankOrNotAlphanumeric(
      CVerificationQueue verifier, final int waitInSeconds) {
  ...
  default void verifyIsEmpty(
      CVerificationQueue verifier, final int waitInSeconds, final int intervalInMilliSeconds) {
    verifyIsEmpty(
        verifier, waitInSeconds, intervalInMilliSeconds, getDefaultMessage("Value Is Empty"));
  }
  ...
  default void verifyMatches(
      ...
      final Object... params) {
    verifyMatches(
        verifier, pattern, waitInSeconds, getDefaultWaitIntervalInMilliSeconds(), message, params);
  }
  ...
  default void verifyMatchesAny(
      ...
      final Object... params) {
    verifyMatchesAny(
        verifier, patterns, waitInSeconds, getDefaultWaitIntervalInMilliSeconds(), message, params);
  }
   ...
   */
  default void verifyMatchesAny(
      CVerificationQueue verifier, final List<Pattern> patterns, final int waitInSeconds) {
  ...
  default void verifyMatchesAny(
    ...
    verifyMatchesAny(
        ...
        waitInSeconds,
        getDefaultWaitIntervalInMilliSeconds(),
        getDefaultMessage("Value Matches Any Of the Provided Patterns"));
  }
  ...
  default void verifyMatchesNone(
    ...
    verifyMatchesNone(
        ...
        waitInSeconds,
        intervalInMilliSeconds,
        getDefaultMessage("Value Matches None Of Provided Pattern"));
  }
   ...
   */
  default void verifyMatches(
      CVerificationQueue verifier, final Pattern pattern, final int waitInSeconds) {
   ...
   */
  default void verifyMatches(
      CVerificationQueue verifier, final String pattern, final int waitInSeconds) {
    verifyMatches(verifier, pattern, waitInSeconds, getDefaultWaitIntervalInMilliSeconds());
  }
  ...
  default void verifyIsNotBlank(
      CVerificationQueue verifier, final int waitInSeconds, final int intervalInMilliSeconds) {
    verifyIsNotBlank(
        verifier, waitInSeconds, intervalInMilliSeconds, getDefaultMessage("Value Is Not Blank"));
  }
  ...
  default void verifyIsNotEmpty(
      CVerificationQueue verifier, final int waitInSeconds, final int intervalInMilliSeconds) {
    verifyIsNotEmpty(
        verifier, waitInSeconds, intervalInMilliSeconds, getDefaultMessage("Value Is Not Empty"));
  }
   ...
   */
  default void verifyLeftValueEquals(
      CVerificationQueue verifier, int len, final String expected, final int waitInSeconds) {
    verifyLeftValueEquals(
  ...
  default void verifyMidValueEquals(
      ...
      final int waitInSeconds) {
    verifyMidValueEquals(
        verifier, pos, len, expected, waitInSeconds, getDefaultWaitIntervalInMilliSeconds());
  }
   ...
   */
  default void verifyNumberOfMatchesEquals(
      CVerificationQueue verifier, String subString, int expected, final int waitInSeconds) {
    verifyNumberOfMatchesEquals(
        verifier, subString, expected, waitInSeconds, getDefaultWaitIntervalInMilliSeconds());
  }
   ...
   */
  default void verifyRemoveEndEquals(
      CVerificationQueue verifier, String remove, final String expected, final int waitInSeconds) {
    verifyRemoveEndEquals(
  ...
  default void verifyStripedEndValue(
      ...
      final int waitInSeconds) {
    verifyStripedEndValue(
        verifier, stripChars, expected, waitInSeconds, getDefaultWaitIntervalInMilliSeconds());
  }
  ...
  default void verifySubstringAfterEquals(
      ...
      final int waitInSeconds) {
    verifySubstringAfterEquals(
        verifier, separator, expected, waitInSeconds, getDefaultWaitIntervalInMilliSeconds());
  }
  ...
  default void verifySubstringBetweenEquals(
      ...
      final int waitInSeconds) {
    verifySubstringBetweenEquals(
        verifier, open, close, expected, waitInSeconds, getDefaultWaitIntervalInMilliSeconds());
  }
   ...
   */
  default void verifySubstringEquals(
      CVerificationQueue verifier, int start, final String expected, final int waitInSeconds) {
    verifySubstringEquals(
  ...
  default void verifySubstringEquals(
      ...
      final int waitInSeconds) {
    verifySubstringEquals(
        verifier, start, end, expected, waitInSeconds, getDefaultWaitIntervalInMilliSeconds());
  }
   ...
   */
  default void verifyTruncatedValueEquals(
      CVerificationQueue verifier, int maxWidth, final String expected, final int waitInSeconds) {
    verifyTruncatedValueEquals(
        verifier, maxWidth, expected, waitInSeconds, getDefaultWaitIntervalInMilliSeconds());
  }
