...
public interface CMapVerifier<K, V> extends CObjectVerifier<Map<K, V>, CMapState<K, V>> {
  ...
  default void verifyContains(Map.Entry<K, V> expected, final String message, final Object... params) {
    _verify(expected, false, (a, e) -> {
      ...
      if (!get().keySet().contains(expected.getKey())) {
        getLogger().warn("Key does not exist in map. Expected: '{}' Actual: '{}'", expected.getKey(), get().keySet());
        return false;
      }

      V value = get().get(expected.getKey());
      if (!Objects.equals(value, expected.getValue())) {
        getLogger().warn("Expected Value does not match the map entity. Expected: '{}' Actual: '{}'", expected.getValue(), value);
        return false;
      }
  ...
  default void verifyContainsAll(Map<K, V> expected, final String message, final Object... params) {
    _verify(expected, false, (a, e) -> {
      ...
      if (!diff.isEmpty()) {
        getLogger().warn("Actual list does not contain following records:\n" + diff);
      }
  ...
  default void verifyContainsNone(Map<K, V> expected, final String message, final Object... params) {
    _verify(expected, false, (a, e) -> {
      ...
      if (!diff.isEmpty()) {
        getLogger().warn("Actual list contains following records:\n" + diff);
      }
  ...
  default void verifyEmptyOrContains(Map.Entry<K, V> expected, final String message, final Object... params) {
    ...
    _verify(expected, false, (a, e) -> {
      ...
      if (!get().keySet().contains(expected.getKey())) {
        getLogger().warn("Key does not exist in map. Expected Key: '{}' Actual keys: '{}'", expected.getKey(), get().keySet());
        return false;
      }

      V value = get().get(expected.getKey());
      if (!Objects.equals(value, expected.getValue())) {
        getLogger().warn("Expected Value does not match the map entity. Expected Key: '{}' Actual keys: '{}'", expected.getValue(), value);
        return false;
      }
  ...
  default void verifyEmptyOrNotContains(Map.Entry<K, V> expected, final String message, final Object... params) {
    Objects.requireNonNull(expected.getKey());
    _verify(expected, false, (a, e) -> _toState(a).emptyOrNotContains(expected), message, params);
  }
  ...
  default void verifyEquals(Map<K, V> expected, final String message, final Object... params) {
    _verify(expected, false, (o, o2) -> {
      ...
      if (!diffActual.isEmpty()) {
        getLogger().warn("Expected list does not contain following records:\n" + diffActual);
      }
      return equals;
    }, message, params);
  }
  ...
  default void verifyIsEmpty(final String message, final Object... params) {
    _verify(true, false, (o, o2) -> get() == null || get().isEmpty(), message, params);
  }
  ...
  default void verifyIsNotEmpty(final String message, final Object... params) {
    _verify(true, false, (o, o2) -> _toState(o).isNotEmpty(), message, params);
  }
  ...
  default void verifyNotContainsAll(Map<K, V> expected, final String message, final Object... params) {
    _verify(expected, false, (o, o2) -> _toState(o).notContainsAll(o2), message, params);
  }
  ...
  default void verifySizeEquals(int expected, final String message, final Object... params) {
    _verify(expected, false, (o, o2) -> _toState(o).sizeEquals(o2), message, params);
  }
  ...
  default void verifySizeIsGreaterThan(int expected, final String message, final Object... params) {
    _verify(expected, false, (o, o2) -> _toState(o).sizeIsGreaterThan(o2), message, params);
  }
  ...
  default void verifySizeIsGreaterThanOrEqual(int expected, final String message, final Object... params) {
    _verify(expected, false, (o, o2) -> _toState(o).sizeIsGreaterThanOrEqual(o2), message, params);
  }
  ...
  default void verifySizeIsLessThan(int expected, final String message, final Object... params) {
    _verify(expected, false, (o, o2) -> _toState(o).sizeIsLessThan(o2), message, params);
  }
  ...
  default void verifySizeIsLessThanOrEqual(int expected, final String message, final Object... params) {
    _verify(expected, false, (o, o2) -> _toState(o).sizeIsLessThanOrEqual(o2), message, params);
  }
}
