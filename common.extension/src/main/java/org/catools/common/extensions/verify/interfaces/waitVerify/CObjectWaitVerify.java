 ...
 */
public interface CObjectWaitVerify<O, S extends CObjectState<O>>
    extends CObjectVerify<O, S>, CBaseVerify<O, S> {
  ...
  default void verifyEquals(
      final O expected, final int waitInSeconds, final String message, final Object... params) {
  ...
  default void verifyEqualsAny(
      List<O> expectedList, final int waitInSeconds, final String message, final Object... params) {
    verifyEqualsAny(
  ...
  default void verifyNotEquals(
      final O expected, final int waitInSeconds, final int intervalInMilliSeconds) {
    verifyNotEquals(
        expected, waitInSeconds, intervalInMilliSeconds, getDefaultMessage("Are Not Equals"));
  }
