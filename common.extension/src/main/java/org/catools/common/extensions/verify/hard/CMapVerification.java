...
public class CMapVerification extends CBaseVerification {
   ...
   */
  public <K, V> void sizeEquals(
      Map<K, V> actual, int expected, final String message, final Object... params) {
   ...
   * @param params parameters for message if message is a string format
   */
  public <K, V> void sizeIsGreaterThan(
      Map<K, V> actual, int expected, final String message, final Object... params) {
   ...
   * @param params parameters for message if message is a string format
   */
  public <K, V> void sizeIsGreaterThanOrEqual(
      Map<K, V> actual, int expected, final String message, final Object... params) {
   ...
   * @param params parameters for message if message is a string format
   */
  public <K, V> void sizeIsLessThan(
      Map<K, V> actual, int expected, final String message, final Object... params) {
   ...
   * @param params parameters for message if message is a string format
   */
  public <K, V> void sizeIsLessThanOrEqual(
      Map<K, V> actual, int expected, final String message, final Object... params) {
