...
public interface CMap<K, V> extends Map<K, V>, CMapVerifier<K, V>, CMapState<K, V> {
  /**
   ...
   * CHashMap}. The preferred alternative to this method is {@link #getFirst(BiPredicate)}, {@link
   * #getFirstValueByKey(Predicate)} {@link #getFirstKeyByValue(Predicate)} {@link
   * #getAllValues(Predicate)}, {@link #getAllKeys(Predicate)}.
   *
   ...
   * return empty list. The preferred alternative to this method is {@link #getFirst(BiPredicate)},
   * {@link #getAll(BiPredicate)}, {@link #getFirstValueByKey(Predicate)} {@link
   * #getFirstKeyByValue(Predicate)} {@link #getAllValues(Predicate)}.
   *
   ...
   * #getFirst(BiPredicate)}, {@link #getAll(BiPredicate)}, {@link #getFirstValueByKey(Predicate)}
   * {@link #getFirstKeyByValue(Predicate)} {@link #getAllKeys(Predicate)}.
   *
   ...
   * #getAll(BiPredicate)}, {@link #getFirstValueByKey(Predicate)} {@link
   * #getFirstKeyByValue(Predicate)} {@link #getAllValues(Predicate)}, {@link
   ...
   * #getFirst(BiPredicate)}, {@link #getAll(BiPredicate)}, {@link #getFirstValueByKey(Predicate)}
   * {@link #getAllValues(Predicate)} {@link #getAllKeys(Predicate)}.
   *
  ...
  /**
   * Returns key of first element from map which its value match the {@code predicate} otherwise
   * return null. The preferred alternative to this method is {@link #getFirst(BiPredicate)}, {@link
   * #getAll(BiPredicate)}, {@link #getFirstValueByKey(Predicate)} {@link #getAllValues(Predicate)}
   * {@link #getAllKeys(Predicate)}.
   *
   * @param value value to search for
   * @return key of first element from map which matched the {@code predicate} otherwise return
   * null.
  ...
  /**
   * Returns value of first element from map which its key match the {@code predicate} otherwise
   * return otherValue. The preferred alternative to this method is {@link #getFirst(BiPredicate)},
   * {@link #getAll(BiPredicate)}, {@link #getFirstValueByKey(Predicate)} {@link
   * #getFirstKeyByValue(Predicate)} {@link #getAllKeys(Predicate)}.
   *
   * @param key        the key we are searching for
