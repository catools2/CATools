...
public class CFileWaitVerifyTest extends CBaseUnitTest {
  ...
  public void testEquals() {
    ...
    toWaitVerify(getPath("testEquals", paragraphs))
        .verifyEqualsStringContent(getFile("testEquals2", paragraphs));
  }
  ...
  public void testEqualsWhenNoDest() {
    String paragraphs = RandomStringUtils.randomAlphabetic(50);
    toWaitVerify(getPath("testEquals1WhenNoDest1", paragraphs))
  ...
  public void testEqualsWhenNoSource() {
    String paragraphs = RandomStringUtils.randomAlphabetic(50);
    toWaitVerify(
            new CFile(getPath("testEquals1WhenNoDest1", paragraphs) + "Invalid").getCanonicalPath())
        .verifyEqualsStringContent(getFile("testEquals1WhenNoDest12", paragraphs));
  }

  @Test(retryAnalyzer = CTestRetryAnalyzer.class, expectedExceptions = AssertionError.class)
  public void testEqualsWhenNotEqual() {
    String paragraphs = RandomStringUtils.randomAlphabetic(50);
    toWaitVerify(getPath("testEquals1WhenNotEqual1", paragraphs))
        .verifyEqualsStringContent(getFile("testEquals1WhenNotEqual12", paragraphs + "1"), 0, 100);
  }

  @Test(retryAnalyzer = CTestRetryAnalyzer.class)
  public void testNotEquals() {
    String paragraphs = RandomStringUtils.randomAlphabetic(50);
    toWaitVerify(getPath("testNotEquals", paragraphs + "1"))
        .verifyNotEqualsStringContent(getFile("testNotEquals2", paragraphs));
  }

  @Test(retryAnalyzer = CTestRetryAnalyzer.class, expectedExceptions = AssertionError.class)
  public void testNotEquals_NoDest() {
    String paragraphs = RandomStringUtils.randomAlphabetic(50);
    toWaitVerify(getPath("testNotEquals_NoDest", paragraphs + "1"))
  ...
  public void testNotEquals_NoSrc() {
    ...
    toWaitVerify(
            new CFile(getPath("testNotEquals_NoSrc", paragraphs + "1") + "Invalid")
                .getCanonicalPath())
        .verifyNotEqualsStringContent(getFile("testNotEquals_NoSrc2", paragraphs));
  }

  @Test(retryAnalyzer = CTestRetryAnalyzer.class, expectedExceptions = AssertionError.class)
  public void testNotEquals_NotEqual() {
    String paragraphs = RandomStringUtils.randomAlphabetic(50);
    toWaitVerify(getPath("testNotEquals_NotEqual", paragraphs))
        .verifyNotEqualsStringContent(getFile("testNotEquals_NotEqual2", paragraphs), 0, 100);
  }
