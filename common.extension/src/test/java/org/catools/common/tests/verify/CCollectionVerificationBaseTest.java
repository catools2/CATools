...
public abstract class CCollectionVerificationBaseTest extends CBaseUnitTest {
  ...
  public void testContains() {
    ...
    verify(
        collection ->
            collection.contains(List.of(1, 2, 3), 2, "CollectionExpectationTest ::> contains "));
  ...
  public void testContainsAll() {
    ...
    verify(
        collection ->
            collection.containsAll(
                new CList<>(1, 2, 3), List.of(1, 3), "CollectionExpectationTest ::> containsAll "));
    ...
    verify(
        collection ->
            collection.containsAll(
                new CSet<>(1, 2, 3), List.of(2, 3), "CollectionExpectationTest ::> containsAll "));
  ...
  public void testContains_N2() {
    verify(
        collection ->
            collection.contains(List.of(1, 2, 3), 5, "CollectionExpectationTest ::> contains "));
  }
  ...
  public void testEquals() {
    ...
    verify(
        collection ->
            collection.equals(
                new CList<>(1, 2, 3), List.of(1, 2, 3), "CollectionExpectationTest ::> equals "));
    ...
    verify(
        collection ->
            collection.equals(
                new CSet<>(1, 2, 3), List.of(1, 2, 3), "CollectionExpectationTest ::> equals "));
    verify(collection -> collection.equals(new CSet<>(), List.of()));
    verify(
        collection ->
            collection.equals(new CSet<>(), List.of(), "CollectionExpectationTest ::> equals "));
  }
  ...
  public void testIsNotEmpty() {
    ...
    verify(
        collection ->
            collection.isNotEmpty(List.of(3), "CollectionExpectationTest ::> isNotEmpty "));
  }
  ...
  public void testNotContains() {
    ...
    verify(
        collection ->
            collection.notContains(List.of(1), 2, "CollectionExpectationTest ::> notContains "));
    verify(collection -> collection.notContains(new CSet<>(), List.of(1)));
    verify(
        collection ->
            collection.notContains(
                new CSet<>(), List.of(1), "CollectionExpectationTest ::> notContains "));
  }
  ...
  public void testNotContainsAll() {
    ...
    verify(
        collection ->
            collection.notContainsAll(
                new CSet<>(), List.of(1), "CollectionExpectationTest ::> notContainsAll "));
  }
