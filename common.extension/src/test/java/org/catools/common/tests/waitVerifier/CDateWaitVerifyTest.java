...
public class CDateWaitVerifyTest extends CBaseWaitVerifyTest {
  ...
  public void testEqualByFormat() {
    ...
    verify(
        verifier ->
            toWaitVerifier(actual)
                .verifyEqualsByFormat(verifier, actual.clone().addMinutes(10), "yyyy-MM-dd HH:ss"));
    verify(
        verifier ->
            toWaitVerifier(actual)
                .verifyEqualsByFormat(
                    verifier, actual.clone().addMinutes(10), "yyyy-MM-dd HH:ss", 1));
  }
  ...
  public void testEqualByFormat_ActualNull() {
    ...
    verify(
        verifier ->
            toWaitVerifier(null).verifyEqualsByFormat(verifier, expected, "yyyy-MM-dd HH:mm:ss"));
  }
  ...
  public void testEqualByFormat_BothNull() {
    verify(
        verifier ->
            toWaitVerifier(null).verifyEqualsByFormat(verifier, null, "yyyy-MM-dd HH:mm:ss"));
  }
  ...
  public void testEqualByFormat_ExpectedNull() {
    ...
    verify(
        verifier ->
            toWaitVerifier(actual).verifyEqualsByFormat(verifier, null, "yyyy-MM-dd HH:mm:ss"));
  }
  ...
  public void testEqualByFormat_NotEquals() {
    ...
    verify(
        verifier ->
            toWaitVerifier(actual)
                .verifyEqualsByFormat(
                    verifier, actual.clone().addMinutes(10), "yyyy-MM-dd HH:mm:ss"));
  }
  ...
  public void testEqualTimePortion() {
    ...
    verify(
        verifier ->
            toWaitVerifier(actual).verifyEqualsTimePortion(verifier, actual.clone().addDays(10)));
    verify(
        verifier ->
            toWaitVerifier(actual)
                .verifyEqualsTimePortion(verifier, actual.clone().addDays(10), 1));
  }
  ...
  public void testEqualTimePortion_ActualNull() {
    ...
    verify(
        verifier ->
            toWaitVerifier(null).verifyEqualsTimePortion(verifier, actual.clone().addSeconds(10)));
  }
  ...
  public void testEqualTimePortion_NotEquals() {
    ...
    verify(
        verifier ->
            toWaitVerifier(actual)
                .verifyEqualsTimePortion(verifier, actual.clone().addSeconds(10)));
  }
  ...
  public void testEqualsDatePortion() {
    ...
    verify(
        verifier ->
            toWaitVerifier(actual)
                .verifyEqualsDatePortion(verifier, actual.clone().addMinutes(10)));
    verify(
        verifier ->
            toWaitVerifier(actual)
                .verifyEqualsDatePortion(verifier, actual.clone().addMinutes(10), 1));
  }
  ...
  public void testEqualsDatePortion_NotEquals() {
    ...
    verify(
        verifier ->
            toWaitVerifier(actual).verifyEqualsDatePortion(verifier, actual.clone().addDays(10)));
  }
  ...
  public void testEquals_NotEquals() {
    CDate actual = CDate.valueOf("2018-01-01", "yyyy-MM-dd");
    verify(
        verifier -> toWaitVerifier(actual).verifyEquals(verifier, actual.clone().addMinutes(10)));
  }
        ...
        verifier ->
            toWaitVerifier(actual)
                .verifyNotEqualsByFormat(
                    verifier, actual.clone().addSeconds(10), "yyyy-MM-dd HH:mm:ss", 1));
    verify(
        verifier ->
            toWaitVerifier(actual).verifyNotEqualsByFormat(verifier, null, "yyyy-MM-dd HH:mm:ss"));
    verify(
        verifier ->
            toWaitVerifier(null).verifyNotEqualsByFormat(verifier, actual, "yyyy-MM-dd HH:mm:ss"));
  }
  ...
  public void testNotEqualByFormat_BothNull() {
    verify(
        verifier ->
            toWaitVerifier(null).verifyNotEqualsByFormat(verifier, null, "yyyy-MM-dd HH:mm"));
  }
  ...
  public void testNotEqualByFormat_Equals() {
    ...
    verify(
        verifier ->
            toWaitVerifier(actual)
                .verifyNotEqualsByFormat(
                    verifier, actual.clone().addSeconds(10), "yyyy-MM-dd HH:mm"));
  }
  ...
  public void testNotEqualDatePortion() {
    ...
    verify(
        verifier ->
            toWaitVerifier(actual)
                .verifyNotEqualsDatePortion(verifier, actual.clone().addDays(10), 1));
  ...
  public void testNotEqualDatePortion_Equals() {
    ...
    verify(
        verifier ->
            toWaitVerifier(actual)
                .verifyNotEqualsDatePortion(verifier, actual.clone().addSeconds(10)));
  }
  ...
  public void testNotEqualTimePortion() {
    ...
    verify(
        verifier ->
            toWaitVerifier(actual)
                .verifyNotEqualsTimePortion(verifier, actual.clone().addMinutes(10), 1));
  ...
  public void testNotEqualTimePortion_Equals() {
    ...
    verify(
        verifier ->
            toWaitVerifier(actual)
                .verifyNotEqualsTimePortion(verifier, actual.clone().addDays(10)));
  }
  ...
  public void testNotEquals() {
    ...
    verify(
        verifier ->
            toWaitVerifier(actual).verifyNotEquals(verifier, actual.clone().addSeconds(10), 1));
