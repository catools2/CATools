...
public abstract class CDateVerificationBaseTest extends CBaseUnitTest {
  ...
  public void testEqualByFormat_ActualNull() {
    ...
    verify(date -> date.equalsByFormat(null, expected, "yyyy-MM-dd HH:mm:ss", "DateExpectationTest ::> equalsByFormat "));
  }
  ...
  public void testEqualByFormat_ExpectedNull() {
    ...
    verify(date -> date.equalsByFormat(actual, null, "yyyy-MM-dd HH:mm:ss", "DateExpectationTest ::> equalsByFormat "));
  }
  ...
  public void testEqualByFormat_NotEquals() {
    ...
    verify(date -> date.equalsByFormat(actual, actual.clone().addMinutes(10), "yyyy-MM-dd HH:mm:ss", "DateExpectationTest ::> equalsByFormat "));
  }
  ...
  public void testEqualTimePortion_ActualNull() {
    ...
    verify(date -> date.equalsTimePortion(null, actual.clone().addSeconds(10), "DateExpectationTest ::> equalsDatePortion "));
  }
  ...
  public void testEqualTimePortion_ExpectedNull() {
    ...
    verify(date -> date.equalsTimePortion(actual, null, "DateExpectationTest ::> equalsDatePortion "));
  }
  ...
  public void testEqualTimePortion_NotEquals() {
    ...
    verify(date -> date.equalsTimePortion(actual, actual.clone().addSeconds(10), "DateExpectationTest ::> equalsDatePortion "));
  }
  ...
  public void testEqualsDatePortion_ActualNull() {
    ...
    verify(date -> date.equalsDatePortion(null, expected, "DateExpectationTest ::> equalsDatePortion "));
  }
  ...
  public void testEqualsDatePortion_ExpectedNull() {
    ...
    verify(date -> date.equalsDatePortion(actual, null, "DateExpectationTest ::> equalsDatePortion "));
  }
  ...
  public void testEqualsDatePortion_NotEquals() {
    ...
    verify(date -> date.equalsDatePortion(actual, actual.clone().addDays(10), "DateExpectationTest ::> equalsDatePortion "));
  }
  ...
  public void testEquals_ActualNull() {
    ...
    verify(date -> date.equals(null, actual, "DateExpectationTest ::> equals "));
  }
  ...
  public void testEquals_ExpectedNull() {
    ...
    verify(date -> date.equals(actual, null, "DateExpectationTest ::> equals "));
  }
  ...
  public void testEquals_NotEquals() {
    ...
    verify(date -> date.equals(actual, actual.clone().addMinutes(10), "DateExpectationTest ::> equals "));
  }
  ...
  public void testNotEqualByFormat_BothNull() {
    ...
    verify(date -> date.notEqualsByFormat(null, null, "yyyy-MM-dd HH:mm", "DateExpectationTest ::> notEqualsByFormat "));
  }
  ...
  public void testNotEqualByFormat_Equals() {
    ...
    verify(date -> date.notEqualsByFormat(actual, actual.clone().addSeconds(10), "yyyy-MM-dd HH:mm", "DateExpectationTest ::> notEqualsByFormat "));
  }
  ...
  public void testNotEqualDatePortion_BothNull() {
    ...
    verify(date -> date.notEqualsDatePortion(null, null, "DateExpectationTest ::> equalsDatePortion "));
  }
  ...
  public void testNotEqualDatePortion_Equals() {
    ...
    verify(date -> date.notEqualsDatePortion(actual, actual.clone().addSeconds(10), "DateExpectationTest ::> equalsDatePortion "));
  }
  ...
  public void testNotEqualTimePortion_BothNull() {
    ...
    verify(date -> date.notEqualsTimePortion(null, null, "DateExpectationTest ::> equalsDatePortion "));
  }
  ...
  public void testNotEqualTimePortion_Equals() {
    ...
    verify(date -> date.notEqualsTimePortion(actual, actual.clone().addDays(10), "DateExpectationTest ::> equalsDatePortion "));
  }
  ...
  public void testNotEquals_BothNull() {
    ...
    verify(date -> date.notEquals(null, null, "DateExpectationTest ::> verifyNotEquals "));
  }
  ...
  public void testNotEquals_NotEquals() {
    ...
    verify(date -> date.notEquals(actual, actual.clone(), "DateExpectationTest ::> verifyNotEquals "));
  }
