...
public abstract class CDateVerificationBaseTest extends CBaseUnitTest {
  ...
  public void testEqualByFormat() {
    verify(date -> {
      ...
      date.equalsByFormat(actual, actual.clone().addMinutes(10), "yyyy-MM-dd HH:ss", "DateExpectationTest ::> equalsByFormat ");
    });
  }
  ...
  public void testEqualByFormat_ActualNull() {
    verify(date -> {
      ...
      date.equalsByFormat(null, expected, "yyyy-MM-dd HH:mm:ss", "DateExpectationTest ::> equalsByFormat ");
    });
  }
  ...
  public void testEqualByFormat_BothNull() {
    verify(date -> {
      date.equalsByFormat(null, null, "yyyy-MM-dd HH:mm:ss", "DateExpectationTest ::> equalsByFormat ");
    });
  }
  ...
  public void testEqualByFormat_ExpectedNull() {
    verify(date -> {
      CDate actual = CDate.valueOf("2018-01-01", "yyyy-MM-dd");
      date.equalsByFormat(actual, null, "yyyy-MM-dd HH:mm:ss", "DateExpectationTest ::> equalsByFormat ");
    });
  }
  ...
  public void testEqualByFormat_NotEquals() {
    verify(date -> {
      CDate actual = CDate.valueOf("2018-01-01", "yyyy-MM-dd");
      date.equalsByFormat(actual, actual.clone().addMinutes(10), "yyyy-MM-dd HH:mm:ss", "DateExpectationTest ::> equalsByFormat ");
    });
  }
  ...
  public void testEqualTimePortion_ActualNull() {
    verify(date -> {
      CDate actual = CDate.valueOf("2018-01-01", "yyyy-MM-dd");
      date.equalsTimePortion(null, actual.clone().addSeconds(10), "DateExpectationTest ::> equalsDatePortion ");
    });
  }
  ...
  public void testEqualTimePortion_NotEquals() {
    verify(date -> {
      CDate actual = CDate.valueOf("2018-01-01", "yyyy-MM-dd");
      date.equalsTimePortion(actual, actual.clone().addSeconds(10), "DateExpectationTest ::> equalsDatePortion ");
    });
  }
  ...
  public void testEqualsDatePortion() {
    verify(date -> {
      CDate actual = CDate.valueOf("2018-01-01", "yyyy-MM-dd");
      date.equalsDatePortion(actual, actual.clone().addMinutes(10), "DateExpectationTest ::> equalsDatePortion ");
    });
  }
  ...
  public void testEqualsDatePortion_NotEquals() {
    verify(date -> {
      CDate actual = CDate.valueOf("2018-01-01", "yyyy-MM-dd");
      date.equalsDatePortion(actual, actual.clone().addDays(10), "DateExpectationTest ::> equalsDatePortion ");
    });
  }
  ...
  public void testNotEqualByFormat() {
    CDate actual = CDate.valueOf("2018-01-01", "yyyy-MM-dd");
    verify(date -> {
      date.notEqualsByFormat(actual, actual.clone().addSeconds(10), "yyyy-MM-dd HH:mm:ss", "DateExpectationTest ::> notEqualsByFormat ");
    });
    verify(date -> {
      date.notEqualsByFormat(actual, null, "yyyy-MM-dd HH:mm:ss", "DateExpectationTest ::> notEqualsByFormat ");
    });
    verify(date -> {
      date.notEqualsByFormat(null, actual, "yyyy-MM-dd HH:mm:ss", "DateExpectationTest ::> notEqualsByFormat ");
    });
  }
  ...
  public void testNotEqualByFormat_BothNull() {
    verify(date -> {
      date.notEqualsByFormat(null, null, "yyyy-MM-dd HH:mm", "DateExpectationTest ::> notEqualsByFormat ");
    });
  }
  ...
  public void testNotEqualByFormat_Equals() {
    verify(date -> {
      CDate actual = CDate.valueOf("2018-01-01", "yyyy-MM-dd");
      date.notEqualsByFormat(actual, actual.clone().addSeconds(10), "yyyy-MM-dd HH:mm", "DateExpectationTest ::> notEqualsByFormat ");
    });
  }
  ...
  public void testNotEqualDatePortion() {
    CDate actual = CDate.valueOf("2018-01-01", "yyyy-MM-dd");
    verify(date -> {
      date.notEqualsDatePortion(actual, actual.clone().addDays(10), "DateExpectationTest ::> notEqualsDatePortion ");
    });
    verify(date -> {
  ...
  public void testNotEqualDatePortion_Equals() {
    verify(date -> {
      CDate actual = CDate.valueOf("2018-01-01", "yyyy-MM-dd");
      date.notEqualsDatePortion(actual, actual.clone().addSeconds(10), "DateExpectationTest ::> equalsDatePortion ");
    });
  }
  ...
  public void testNotEqualTimePortion() {
    CDate actual = CDate.valueOf("2018-01-01", "yyyy-MM-dd");
    verify(date -> {
      date.notEqualsTimePortion(actual, actual.clone().addMinutes(10), "DateExpectationTest ::> notEqualsTimePortion ");
    });
    verify(date -> {
  ...
  public void testNotEqualTimePortion_Equals() {
    verify(date -> {
      CDate actual = CDate.valueOf("2018-01-01", "yyyy-MM-dd");
      date.notEqualsTimePortion(actual, actual.clone().addDays(10), "DateExpectationTest ::> equalsDatePortion ");
    });
  }
  ...
  public void testNotEquals() {
    CDate actual = CDate.valueOf("2018-01-01", "yyyy-MM-dd");
    verify(date -> {
      date.notEquals(actual, actual.clone().addSeconds(10), "DateExpectationTest ::> verifyNotEquals ");
    });
    verify(date -> {
