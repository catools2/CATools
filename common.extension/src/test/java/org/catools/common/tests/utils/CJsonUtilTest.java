...
public class CJsonUtilTest extends CBaseUnitTest {
  ...
  public void testClone() {
    ...
    clone.remove(0);
    verify.Int.equals(clone.size(), 2, "Clone object has 2 records after remove");
    verify.Int.equals(info.size(), 3, "Original object has 3 records after remove get on clone");
  }
