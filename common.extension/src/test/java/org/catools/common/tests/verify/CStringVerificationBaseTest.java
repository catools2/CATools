...
public abstract class CStringVerificationBaseTest extends CBaseUnitTest {
  ...
  public void testSubstringsBetweenEquals() {
    verify(string -> string.substringsBetweenEquals("  some string   s ", " ", "s", new CList<>(" ", "", "  "), "some string", "testSubstringsBetween"));
  }
  ...
  public void testSubstringsBetweenNotEquals() {
    verify(string -> string.substringsBetweenNotEquals("  some string   s ", " ", "s", new CList<>(" ", "S", "  "), "some string", "testSubstringsBetweenNotEquals"));
  }
