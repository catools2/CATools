...
public class CCollectionTest extends CBaseUnitTest {
  ...
  public void testAdd1() {
    ...
    CCollection<String> strings = new CList<>("A", "B", "C");
    strings.add("C");
  ...
  public void testAdd2() {
    CVerifier verifier = new CVerifier();
    CCollection<String> strings = new CSet<>("A", "B", "C");
    strings.add("C");
  ...
  public void testAddIf1() {
    CVerifier verifier = new CVerifier();
    CCollection<String> strings = new CSet<>("A", "B");
  ...
  public void testForEach() {
    CVerifier verifier = new CVerifier();
    CCollection<String> output = new CList<>();
  ...
  public void testGetAny() {
    CVerifier verifier = new CVerifier();
    CCollection<String> list1 = new CSet<>("A", "B", "C");
  ...
  public void testGetAnyAndRemove() {
    CVerifier verifier = new CVerifier();
    CCollection<String> list1 = new CSet<>("A", "C");
    String val;
  ...
  public void testMap() {
    CVerifier verifier = new CVerifier();
    verifier.String.equals(
        ((CCollection<String>) new CList<>("A", "B"))
            .map(s -> s.toLowerCase())
  ...
  public void testMapToList() {
    CVerifier verifier = new CVerifier();
    verifier.String.equals(
        ((CCollection<String>) new CList<>("A", "B")).mapToList(s -> s.toLowerCase()).join(),
        "ab",
  ...
  public void testMapToSet() {
    CVerifier verifier = new CVerifier();
    verifier.String.equals(
        ((CCollection<String>) new CList<>("A", "B", "B", "C"))
