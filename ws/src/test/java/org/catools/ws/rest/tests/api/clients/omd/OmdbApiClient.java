...
import org.catools.ws.rest.tests.COMDBAClientTest;
import org.catools.ws.rest.tests.api.config.ConfigUtils;

public abstract class OmdbApiClient<O> extends CHttpRestClient<COMDBAClientTest, O> {
  private static final String BASE_URL = ConfigUtils.getApiHost();
  private static final String API_KEY = ConfigUtils.getApiKey();

  public OmdbApiClient(COMDBAClientTest testInstance, CHttpRequestType requestType) {
    this(testInstance, requestType, null);
  }

  public OmdbApiClient(COMDBAClientTest testInstance, CHttpRequestType requestType, String targetPath) {
    super(testInstance, requestType, BASE_URL, targetPath);
