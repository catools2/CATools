...
public class COMDBAClientTest extends CTest {
  ...
  protected void verifySearchMovieTitleInResponse(String search, String[] expectedTitles) {
    Movies response = new OmdbSearchApiClient(this, Map.of(SearchParam.SEARCH, search)).readAllPages();
  ...
  public void verifyGetByIdReturnsExpectedRecord(String search, String title, String released, String director) {
    Movies response = new OmdbSearchApiClient(this, Map.of(SearchParam.SEARCH, search)).readAllPages().getByTitle(title);
    Assertions.assertThat(response.size()).isEqualTo(1);
    MovieDetail movieDetailById = new OmdbGetByIdApiClient(this, response.get(0).getImdbID()).process();
  ...
  public void verifyGetByTitleReturnsExpectedRecord(String title, String plot, String runtime) {
    MovieDetail movieDetailByTitle = new OmdbGetByTitleApiClient(this, title).process();
