...
public class CReportPortalAttributeUtilTest extends CTest {
  ...
  public void testGetSingleKeyAttributes() {
    ...
    evn.verifySizeEquals(verify, 1);
    evn.verifyContains(verify, new ItemAttributesRQ("env"));
  }
  ...
  public void testGetSingleKeyValueAttributesWithoutTerminator() {
    ...
    evn.verifySizeEquals(verify, 1);
    evn.verifyContains(verify, new ItemAttributesRQ("env", "qa"));
  }
  ...
  public void testGetComplexAttributes1() {
    ...
    evn.verifySizeEquals(verify, 4);
    evn.verifyContains(verify, new ItemAttributesRQ("k1", "v1"));
    evn.verifyContains(verify, new ItemAttributesRQ("k2", "v21,v22"));
    evn.verifyContains(verify, new ItemAttributesRQ("k3"));
    evn.verifyContains(verify, new ItemAttributesRQ("k4", "v4"));
  }
