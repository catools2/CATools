 ...
 *
 * <p>This class models the structure of an execution in the ZAPI system, including its metadata
 * such as execution status, associated cycle, project, and defect details.
 */
@Data
@NoArgsConstructor
