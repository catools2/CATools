 ...
 * a set of {@link CZApiExecutionDefect} objects, including constructors for various input types.</p>
 */
public class CZApiExecutionDefects extends CSet<CZApiExecutionDefect> {
  ...
  /**
   * Constructs a collection of execution defects from an array of {@link CZApiExecutionDefect} objects.
   *
  ...
  /**
   * Constructs a collection of execution defects from a {@link Stream} of {@link CZApiExecutionDefect} objects.
   *
  ...
  /**
   * Constructs a collection of execution defects from an {@link Iterable} of {@link CZApiExecutionDefect} objects.
   *
