...
public class CChromeDriverProvider implements CDriverProvider {
  ...
  public CChromeDriverProvider setHeadless(boolean value) {
    options.setHeadless(value);
    addArguments(CChromeConfigs.getHeadLessArguments());
    return this;
  }

  public CChromeDriverProvider setDownloadFolder(File tempDownloadFolder) {
