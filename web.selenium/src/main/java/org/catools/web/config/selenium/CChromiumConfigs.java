...
public class CChromiumConfigs {
  ...
  public static String getBinaryPath() {
    return CHocon.asString(Configs.CATOOLS_WEB_CHROMIUM_BINARY_PATH);
  }
  ...
  public static List<String> getDefaultArguments() {
    return CHocon.asStrings(Configs.CATOOLS_WEB_CHROMIUM_DEFAULT_ARGUMENTS);
  }
  ...
  public static List<String> getPluginsToDisable() {
    return CHocon.asStrings(Configs.CATOOLS_WEB_CHROMIUM_PLUGINS_TO_DISABLE);
  }
  ...
  public static List<String> getPluginsToEnable() {
    return CHocon.asStrings(Configs.CATOOLS_WEB_CHROMIUM_PLUGINS_TO_ENABLE);
  }
  ...
  public static boolean isInHeadLessMode() {
    return CHocon.asBoolean(Configs.CATOOLS_WEB_CHROMIUM_HEADLESS_ENABLE);
  }
  ...
  public static List<String> getHeadLessArguments() {
    return CHocon.asStrings(Configs.CATOOLS_WEB_CHROMIUM_HEADLESS_ARGUMENTS);
  }
  ...
  public static String getChromeMobileEmulationDeviceName() {
    return CHocon.asString(Configs.CATOOLS_WEB_CHROMIUM_MOBILE_EMULATION_DEVICE_NAME);
  }

  @Getter
  @AllArgsConstructor
  private enum Configs implements CHoconPath {
    CATOOLS_WEB_CHROMIUM_BINARY_PATH("catools.web.chromium.binary_path"),
    CATOOLS_WEB_CHROMIUM_DEFAULT_ARGUMENTS("catools.web.chromium.default_arguments"),
    CATOOLS_WEB_CHROMIUM_PAGE_LOAD_STRATEGY("catools.web.chromium.page_load_strategy"),
    CATOOLS_WEB_CHROMIUM_PLUGINS_TO_DISABLE("catools.web.chromium.plugins_to_disable"),
