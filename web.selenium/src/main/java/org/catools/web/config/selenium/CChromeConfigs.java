 ...
 *
 * <p>This class provides static methods to retrieve various Chrome browser configuration properties
 * from the application configuration using HOCON format. All configuration values are read from the
 * application's configuration files and can be overridden through system properties or environment
 * variables.
 *
 * @since 1.0
 */
...
public class CChromeConfigs {
   ...
   *
   * <p>This method returns the configured path to the Chrome browser executable. If not specified
   * in the configuration, Chrome will use its default installation path.
   *
  ...
  private enum Configs implements CHoconPath {
    ...
    CATOOLS_WEB_CHROME_MOBILE_EMULATION_DEVICE_NAME(
        "catools.web.chrome.mobile_emulation_device_name");
