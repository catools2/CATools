 ...
 *
 * <p>Produces the appropriate {@code CSeleniumProvider} implementation for the requested browser.
 * Keep the API small — use {@link #create(CBrowser)} for defaults and the overloads for headless or
 * custom options.
 *
 * <p>Examples:
 *
