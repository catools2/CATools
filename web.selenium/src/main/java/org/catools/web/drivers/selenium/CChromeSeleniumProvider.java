...
public class CChromeSeleniumProvider implements CSeleniumProvider {
  ...
  public CChromeSeleniumProvider() {
    ...
    if (CChromeConfigs.isInHeadLessMode()) setHeadless();
  }
   ...
   * to any default arguments configured in {@link CChromeConfigs}.
   *
   ...
   * CChromeConfigs#getHeadLessArguments()}.
   *
