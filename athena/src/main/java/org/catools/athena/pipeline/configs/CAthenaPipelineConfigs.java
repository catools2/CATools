...
public class CAthenaPipelineConfigs {
    ...
    private enum Configs implements CHoconPath {
        ...
        CATOOLS_ATHENA_PIPELINE_LISTENER_ALWAYS_CREATE_NEW_PIPELINE("catools.athena.pipeline.listener.always_create_new_pipeline"),
        CATOOLS_ATHENA_PIPELINE_LISTENER_CREATE_IF_NOT_EXIST("catools.athena.pipeline.listener.create_if_not_exist");
