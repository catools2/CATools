...
@Slf4j
public class CAthenaPipelineListener implements IExecutionListener, ISuiteListener, IClassListener, IResultListener, IConfigurationListener, IInvokedMethodListener {
    ...
    protected void addResult(ITestResult testResult) {
        ...
        CPipelineHelper.addResult(testResult,
                pipeline,
