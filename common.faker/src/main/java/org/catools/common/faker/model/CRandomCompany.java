...
/**
 * Represents a randomly generated company with various naming components. This class is used for
 * generating fake company data for testing purposes.
 *
 * <p>The class uses Lombok annotations to automatically generate boilerplate code:
 *
 * <ul>
 *   <li>{@code @Data} - generates getters, setters, toString, equals, and hashCode methods
 *   <li>{@code @NoArgsConstructor} - generates a no-argument constructor
 *   <li>{@code @AllArgsConstructor} - generates a constructor with all fields as parameters
 *   <li>{@code @Accessors(chain = true)} - enables method chaining for setters
 * </ul>
 *
...
public class CRandomCompany {
  ...
  /**
   * The main name of the company. This is typically the core business identifier.
   *
  ...
  /**
   * The suffix that appears after the company name. This usually indicates the legal structure or
   * business type.
   *
  ...
  /**
   * The prefix that appears before the company name. This often describes the scope, specialty, or
