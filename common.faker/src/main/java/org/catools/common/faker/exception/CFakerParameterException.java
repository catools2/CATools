 ...
 *
 * <p>This runtime exception is used to indicate that the parameters passed to a CFaker method are
 * invalid, missing, or outside acceptable ranges. It extends RuntimeException to provide unchecked
 * exception handling for parameter validation errors.
 *
...
public class CFakerParameterException extends RuntimeException {
   ...
   *
   * <p>This constructor is used when a parameter validation error occurs and you want to provide a
   ...
   * }</pre>
   *
   * @param description the detail message explaining why the parameter is invalid. The detail
   ...
   *
   * <p>This constructor is useful when a parameter validation error is detected while handling
   * another exception, allowing you to wrap the original exception while providing context about
   * the parameter validation failure.
   *
   * <h3>Usage Examples:</h3>
   *
   * <pre>{@code
   ...
   * }</pre>
   *
   * @param message the detail message explaining why the parameter is invalid. The detail message
