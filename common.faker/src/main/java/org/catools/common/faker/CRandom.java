...
/**
 * CRandom is a comprehensive faker and random data generation utility that provides methods
 * for generating various types of fake data including numbers, strings, names, addresses,
 * phone numbers, and company information.
 * 
 * <p>This class is organized into nested static classes for different data types:</p>
 * <ul>
 *   <li>{@link Int} - Integer generation</li>
 *   <li>{@link Long} - Long number generation</li>
 *   <li>{@link Double} - Double precision number generation</li>
 *   <li>{@link Float} - Float number generation</li>
 *   <li>{@link BigDecimal} - BigDecimal number generation</li>
 *   <li>{@link String} - Text and Lorem Ipsum generation</li>
 *   <li>{@link PhoneNumber} - Phone number generation</li>
 *   <li>{@link PersonName} - Person name generation</li>
 *   <li>{@link Address} - Address generation</li>
 *   <li>{@link Company} - Company information generation</li>
 *   <li>{@link Country} - Country information generation</li>
 * </ul>
 * 
 * <p>Example usage:</p>
 * <pre>{@code
...
public class CRandom {
   ...
   * 
   * <p>This class provides methods for generating random integers within specified ranges
   * or using default bounds.</p>
   * 
   * <p>Example usage:</p>
   * <pre>{@code
   ...
   * 
   * <p>This class provides methods for generating random long integers within specified ranges
   * or using default bounds. Useful for generating IDs, timestamps, or large numeric values.</p>
   * 
   * <p>Example usage:</p>
   * <pre>{@code
   ...
   * 
   * <p>This class provides methods for generating random BigDecimal numbers within specified ranges.
   * BigDecimal is ideal for financial calculations, monetary values, and situations requiring
   * precise decimal arithmetic.</p>
   * 
   * <p>Example usage:</p>
   * <pre>{@code
   ...
   * 
   * <p>This class provides comprehensive text generation capabilities including:</p>
   * <ul>
   *   <li>Numeric strings of specified lengths</li>
   *   <li>Lorem Ipsum words, statements, and paragraphs</li>
   *   <li>Customizable word and text generation with length controls</li>
   * </ul>
   * 
   * <p>Example usage:</p>
   * <pre>{@code
  ...
  public static class String {
     ...
     * @throws CInvalidRangeException if minLengthInclusive is less than 1 or maxLengthExclusive
     *                                is less than minLengthInclusive
     * 
     * <p>Example usage:</p>
     * <pre>{@code
     ...
     * 
     * <p>Uses the following default parameters:</p>
     * <ul>
     *   <li>minWordLength = 3 characters</li>
     *   <li>maxWordLength = 10 characters</li>
     *   <li>minStatementLength = 15 characters</li>
     *   <li>maxStatementLength = 30 characters</li>
     *   <li>minParagraphLength = 100 characters</li>
     *   <li>maxParagraphLength = 500 characters</li>
     * </ul>
     *
     ...
     *
     * <ul>
     *   <li>minWordLength = 3 Char</li>
     *   <li>maxWordLength = 10 Char</li>
     *   <li>minStatementLength = 15 Char</li>
     *   <li>maxStatementLength = 30 Char</li>
     *   <li>minParagraphLength = {@code minParagraphLength} parameter for minimum length of
     *       paragraph to be generated inclusive</li>
     ...
     *   <li>minStatementLength = 15 Char</li>
     *   <li>maxStatementLength = 30 Char</li>
     *   <li>minParagraphLength = 100 Char</li>
     *   <li>maxParagraphLength = 500 Char</li>
     * </ul>
     *
   ...
   * guaranteed to be valid, working phone numbers.</p>
   * 
   * <p>Supported country codes include:</p>
   * <ul>
   *   <li>US - United States</li>
   *   <li>CA - Canada</li>
   *   <li>GB - Great Britain</li>
   *   <li>And others via phone number utility</li>
   * </ul>
   * 
   * <p>Example usage:</p>
   * <pre>{@code
  ...
  public static class PhoneNumber {
     ...
     * 
     * <p>The method generates phone numbers that follow the general format for each country.
     * For US, CA, and GB, it uses predefined prefixes. For other countries, it uses
     * the Google phone number utility to determine the appropriate format.</p>
     *
   ...
   * 
   * <p>This class provides methods for generating realistic person names from various countries.
   * It supports generating names by gender (male/female) and by country-specific naming conventions.</p>
   * 
   * <p>Features:</p>
   * <ul>
   *   <li>Generate names from any supported country</li>
   *   <li>Gender-specific name generation</li>
   *   <li>Random country selection when country is not specified</li>
   *   <li>Returns {@link CRandomName} objects with first name, last name, and gender information</li>
   * </ul>
   * 
   * <p>Example usage:</p>
   * <pre>{@code
  ...
  public static class PersonName {
     ...
     * 
     * <p>This method randomly selects a country and generates a name appropriate for that
     * country's naming conventions. The gender is also randomly selected.</p>
     *
     ...
     * 
     * <p>This method generates a name using the naming conventions of the specified country.
     * The gender is randomly selected (male or female).</p>
     *
     ...
     * country's naming conventions.</p>
     *
     * @return {@link CRandomName} object containing male first name, last name, and gender information
     * 
     * <p>Example usage:</p>
     * <pre>{@code
     ...
     * 
     * <p>This method generates a male name using the naming conventions of the specified country.</p>
     *
     * @param countryCode3 three-letter country code (e.g., "USA", "GBR", "CAN", "DEU")
     * @return {@link CRandomName} object containing male first name, last name, and gender information
     * @throws CFakerCountryNotFoundException if the country code is not supported
     ...
     * country's naming conventions.</p>
     *
     * @return {@link CRandomName} object containing female first name, last name, and gender information
     * 
     * <p>Example usage:</p>
     * <pre>{@code
     ...
     * 
     * <p>This method generates a female name using the naming conventions of the specified country.</p>
     *
     * @param countryCode3 three-letter country code (e.g., "USA", "GBR", "CAN", "DEU")
     * @return {@link CRandomName} object containing female first name, last name, and gender information
     * @throws CFakerCountryNotFoundException if the country code is not supported
   ...
   * 
   * <p>This class provides methods for generating realistic addresses from various countries.
   * The addresses include street names, cities, states/provinces, postal codes, and country
   * information based on the specified country's addressing conventions.</p>
   * 
   * <p>Features:</p>
   * <ul>
   *   <li>Generate addresses from any supported country</li>
   *   <li>Country-specific address formats and components</li>
   *   <li>Random country selection when country is not specified</li>
   *   <li>Returns {@link CRandomAddress} objects with all address components</li>
   * </ul>
   * 
   * <p>Example usage:</p>
   * <pre>{@code
  ...
  public static class Address {
     ...
     * country's addressing conventions and format.</p>
     *
     ...
     * specified country. The address will include appropriate components like street names,
     * city names, postal codes, and regional divisions based on the country's standards.</p>
     *
     * @param countryCode3 three-letter country code (e.g., "USA", "GBR", "CAN", "DEU")
     * @return {@link CRandomAddress} object containing all address components
     * @throws CFakerCountryNotFoundException if the country code is not supported
   ...
   * 
   * <p>This class provides methods for generating realistic company information from various countries.
   * The generated company data includes company names, business types, and other relevant
   * company information based on the specified country's business conventions.</p>
   * 
   * <p>Features:</p>
   * <ul>
   *   <li>Generate company information from any supported country</li>
   *   <li>Country-specific company names and business types</li>
   *   <li>Random country selection when country is not specified</li>
   *   <li>Returns {@link CRandomCompany} objects with company details</li>
   * </ul>
   * 
   * <p>Example usage:</p>
   * <pre>{@code
  ...
  public static class Company {
     ...
     * 
     * <p>This method randomly selects a country and generates company information appropriate
     * for that country's business conventions and naming patterns.</p>
     *
     ...
     * common business types, and industry classifications.</p>
     *
     * @param countryCode3 three-letter country code (e.g., "USA", "GBR", "CAN", "DEU")
     * @return {@link CRandomCompany} object containing company information
     * @throws CFakerCountryNotFoundException if the country code is not supported
   ...
   * country codes, and other country-related data. This is useful for generating test data
   * for applications that need country information.</p>
   * 
   * <p>Features:</p>
   * <ul>
   *   <li>Generate random country information</li>
   *   <li>Get specific country information by country code</li>
   *   <li>Returns {@link CRandomCountry} objects with country details</li>
   * </ul>
   * 
   * <p>Example usage:</p>
   * <pre>{@code
  ...
  public static class Country {
     ...
     * Generate random country information.
     * 
     * <p>This method randomly selects a country and returns its information including
     * name, codes, and other country-related data.</p>
     *
     ...
     * 
     * <p>This method returns information for the specified country including its name,
     * codes, continent, and other relevant country data.</p>
     *
     * @param countryCode3 three-letter country code (e.g., "USA", "GBR", "CAN", "DEU")
     * @return {@link CRandomCountry} object containing country information
     * @throws CFakerCountryNotFoundException if the country code is not supported
