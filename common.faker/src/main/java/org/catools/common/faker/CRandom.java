...
public class CRandom {
  ...
  public static class String {
    ...
    /**
     * Generate sequence of random generated string using {@link #nextStatement(int, int, int,
    ...
    /**
     * Generate sequence of random generated string using {@link #nextWord(int, int)} using
