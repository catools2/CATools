 ...
 */
@Slf4j
public class CChromePlaywrightProvider implements CPlaywrightProvider {
    ...
    protected CChromePlaywrightProvider() {
    ...
    private Browser createBrowser() {
        ...
        if (launchOptions == null) {
            launchOptions = new BrowserType.LaunchOptions().setChannel("chrome");
        }
