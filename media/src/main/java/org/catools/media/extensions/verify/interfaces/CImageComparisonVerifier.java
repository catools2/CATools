 ...
 */
public interface CImageComparisonVerifier extends CObjectVerifier<BufferedImage, CImageComparisionState> {
  /**
  ...
  default void verifyNotEquals(
    ...
    if (_useWaiter()) {
      ...
      _verify(
          expected, false, (a, b) -> _toState(a).isNotEqual(b), message, params);
    }
  }
