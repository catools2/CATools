...
public interface CImageComparisonWaitVerifier extends CImageComparisonVerify {
   ...
   */
  default void verifyEquals(
      final CVerificationQueue verifier, final CFile expected, final int waitInSeconds) {
    verifyEquals(
        verifier,
   ...
   */
  default void verifyEquals(
      final CVerificationQueue verifier, final CResource expected, final int waitInSeconds) {
    verifyEquals(
        verifier,
        CImageUtil.readImageOrNull(expected),
  ...
  default void verifyNotEquals(
      ...
      final int waitInSeconds) {
    verifyNotEquals(
        verifier, expected, diffFileName, waitInSeconds, getDefaultMessage("Not Equals"));
  }
  ...
  default void verifyNotEquals(
      ...
      final int intervalInMilliSeconds) {
    verifyNotEquals(
        verifier, expected, waitInSeconds, intervalInMilliSeconds, getDefaultMessage("Not Equals"));
  }
  ...
  default void verifyEqualsAny(
      ...
      final int waitInSeconds) {
    verifyEqualsAny(
        verifier, expected, diffFileNamePrefix, waitInSeconds, getDefaultMessage("Equals Any"));
  }
  ...
  default void verifyEqualsNone(
      ...
      final int waitInSeconds) {
    verifyEqualsNone(
        verifier, expected, diffFileNamePrefix, waitInSeconds, getDefaultMessage("Equals None"));
  }
  ...
  default void verifyContains(
      final CVerificationQueue verifier, final BufferedImage expected, final int waitInSeconds) {
  ...
  default void verifyContains(
      ...
      final int intervalInMilliSeconds) {
    verifyContains(
        verifier, expected, TemplateScoreType.NCC, waitInSeconds, intervalInMilliSeconds);
  }
   ...
   */
  default void verifyContains(
      final CVerificationQueue verifier, final File expected, final int waitInSeconds) {
    verifyContains(verifier, expected, TemplateScoreType.NCC, waitInSeconds);
  }
  ...
  default void verifyContains(
      ...
      final int waitInSeconds) {
    verifyContains(
        verifier, expected, scoreType, CMediaConfigs.getDefaultMatchPrecision(), waitInSeconds);
  }
  ...
  default void verifyContains(
      ...
      final int waitInSeconds) {
    verifyContains(
        verifier, expected, scoreType, (BufferedImage) null, matchPrecision, waitInSeconds);
  }
  ...
  default void verifyContains(
      ...
      final int waitInSeconds) {
    verifyContains(
        verifier, toBufferedImage(expected), scoreType, mask, matchPrecision, waitInSeconds);
  }
  ...
  default void verifyContainsAny(
      final CVerificationQueue verifier, final Iterable<?> expected, final int waitInSeconds) {
  ...
  default void verifyContainsAny(
      ...
      final int waitInSeconds) {
    verifyContainsAny(
        verifier, expected, scoreType, toBufferedImage(mask), matchPrecision, waitInSeconds);
  }
  ...
  default void verifyContainsNone(
      ...
      final int intervalInMilliSeconds) {
    verifyContainsNone(
        verifier, expected, scoreType, null, matchPrecision, waitInSeconds, intervalInMilliSeconds);
  }
  ...
  default void verifyContainsNone(
      ...
      final Object... params) {
    verifyContainsNone(
        verifier, expected, scoreType, null, matchPrecision, waitInSeconds, message, params);
  }
