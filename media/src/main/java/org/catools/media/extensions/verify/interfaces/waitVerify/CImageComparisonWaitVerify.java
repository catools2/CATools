...
public interface CImageComparisonWaitVerify extends CImageComparisonVerify {
  ...
  default void verifyEquals(
      final BufferedImage expected, final String diffFileName, final int waitInSeconds) {
  ...
  default void verifyEquals(
      ...
      final int intervalInMilliSeconds) {
    verifyEquals(
        expected, diffFileName, waitInSeconds, intervalInMilliSeconds, getDefaultMessage("Equals"));
  }
   ...
   */
  default void verifyEquals(
      final CFile expected, final int waitInSeconds, final String message, final Object... params) {
    verifyEquals(
        CImageUtil.readImageOrNull(expected), expected.getName(), waitInSeconds, message, params);
  }
  ...
  default void verifyNotEquals(
      final CFile expected, final int waitInSeconds, final int intervalInMilliSeconds) {
    verifyNotEquals(
        expected, waitInSeconds, intervalInMilliSeconds, getDefaultMessage("Not Equals"));
  }
  ...
  default void verifyEqualsAny(
      final Iterable<?> expected, final String diffFileNamePrefix, final int waitInSeconds) {
  ...
  default void verifyContains(
      final BufferedImage expected, final int waitInSeconds, final int intervalInMilliSeconds) {
  ...
  default void verifyContains(
      ...
      final Object... params) {
    verifyContains(
        expected, TemplateScoreType.NCC, waitInSeconds, intervalInMilliSeconds, message, params);
  }
   ...
   */
  default void verifyContains(
      final File expected, final int waitInSeconds, final int intervalInMilliSeconds) {
    verifyContains(expected, TemplateScoreType.NCC, waitInSeconds, intervalInMilliSeconds);
  }
   ...
   */
  default void verifyContains(
      final File expected, final int waitInSeconds, final String message, final Object... params) {
    verifyContains(expected, TemplateScoreType.NCC, waitInSeconds, message, params);
  }
   ...
   */
  default void verifyContains(
      final BufferedImage expected, TemplateScoreType scoreType, final int waitInSeconds) {
   ...
   */
  default void verifyContains(
      final File expected, TemplateScoreType scoreType, final int waitInSeconds) {
    verifyContains(expected, scoreType, CMediaConfigs.getDefaultMatchPrecision(), waitInSeconds);
  }
   ...
   */
  default void verifyContains(
      final CResource expected, TemplateScoreType scoreType, final int waitInSeconds) {
    verifyContains(expected, scoreType, CMediaConfigs.getDefaultMatchPrecision(), waitInSeconds);
  }
  ...
  default void verifyContains(
      ...
      final Object... params) {
    verifyContains(
        expected, scoreType, (BufferedImage) null, matchPrecision, waitInSeconds, message, params);
  }
  ...
  default void verifyContains(
      ...
      final int waitInSeconds) {
    verifyContains(
        expected, scoreType, mask, matchPrecision, waitInSeconds, getDefaultMessage("Contains"));
  }
  ...
  default void verifyContains(
      ...
      final Object... params) {
    verifyContains(
        toBufferedImage(expected), scoreType, mask, matchPrecision, waitInSeconds, message, params);
  }
  ...
  default void verifyNotContains(
    ...
    verifyNotContains(
        ...
        matchPrecision,
        waitInSeconds,
        getDefaultMessage("Not Contains"));
  }
  ...
  default void verifyContainsAny(
      final Iterable<?> expected, final int waitInSeconds, final int intervalInMilliSeconds) {
   ...
   */
  default void verifyContainsAny(
      final Iterable<?> expected, TemplateScoreType scoreType, final int waitInSeconds) {
  ...
  default void verifyContainsAny(
    ...
    verifyContainsAny(
        ...
        matchPrecision,
        waitInSeconds,
        getDefaultMessage("Contains Any"));
  }
  ...
  default void verifyContainsAny(
      ...
      final Object... params) {
    verifyContainsAny(
        expected, scoreType, toBufferedImage(mask), matchPrecision, waitInSeconds, message, params);
  }
  ...
  default void verifyContainsNone(
      final Iterable<?> expected, TemplateScoreType scoreType, final int waitInSeconds) {
    verifyContainsNone(
        expected, scoreType, CMediaConfigs.getDefaultMatchPrecision(), waitInSeconds);
  }
  ...
  default void verifyContainsNone(
      ...
      final int intervalInMilliSeconds) {
    verifyContainsNone(
        expected, scoreType, null, matchPrecision, waitInSeconds, intervalInMilliSeconds);
  }
