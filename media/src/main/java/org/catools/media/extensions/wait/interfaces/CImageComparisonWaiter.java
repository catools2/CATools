...
public interface CImageComparisonWaiter extends CBaseWaiter<BufferedImage> {
  ...
  /**
   * Wait if actual contains expected image with at least 99.9% match precision using {@link
  ...
  default boolean waitContains(
      ...
      final int intervalInMilliSeconds) {
    return _waiter(
        a -> toState(a).contains(expected, scoreType, mask, matchPrecision),
        waitInSeconds,
        intervalInMilliSeconds);
  }
  ...
  default boolean waitNotContains(
      ...
      final int intervalInMilliSeconds) {
    return _waiter(
        a -> toState(a).notContains(expected, scoreType, mask, matchPrecision),
        waitInSeconds,
        intervalInMilliSeconds);
  }
  ...
  /**
   * Wait that actual image contains any of expected images with at least 99.9% match precision
   ...
   * @return execution result
   */
  default boolean waitContainsAny(
      final Iterable<?> expected, final int waitInSeconds, final int intervalInMilliSeconds) {
  ...
  default boolean waitContainsAny(
      ...
      final int intervalInMilliSeconds) {
    return _waiter(
        a -> toState(a).containsAny(expected, scoreType, mask, matchPrecision),
        waitInSeconds,
        intervalInMilliSeconds);
  }
  ...
  /**
   * Wait that actual image does not contain any of expected images with at least 99.9% match
  ...
  default boolean waitContainsNone(
      ...
      final int intervalInMilliSeconds) {
    return _waiter(
        a -> toState(a).containsNone(expected, scoreType, mask, matchPrecision),
        waitInSeconds,
        intervalInMilliSeconds);
  }
