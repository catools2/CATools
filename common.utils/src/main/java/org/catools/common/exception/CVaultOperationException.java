...
public class CVaultOperationException extends RuntimeException {
  ...
  public CVaultOperationException(String operation, VaultException e) {
    super(
        String.format(
            "Failed to perform %s operation against vault. Host: %s.",
            operation, CVaultConfigs.getUrl()),
        e);
  }
  ...
  public CVaultOperationException(String operation, String path, VaultException e) {
    super(
        String.format(
            "Failed to perform %s operation against vault. Host: %s, Path: %s.",
            operation, CVaultConfigs.getUrl(), path),
        e);
  }
}
