package org.catools.common.vault.configs;
...
import org.catools.common.vault.model.CVaultAuthType;

public class CVaultConfigs {

  public static boolean isEnabled() {
    return CHocon.asBoolean(Configs.CATOOLS_VAULT_ENABLED);
  }
  ...
  public static List<String> getPaths() {
    return CHocon.asList(Configs.CATOOLS_VAULT_PATHS, String.class);
  }
  ...
  private enum Configs implements CHoconPath {
    CATOOLS_VAULT_ENABLED("catools.vault.enabled"),
    CATOOLS_VAULT_URL("catools.vault.url"),
    CATOOLS_VAULT_PATHS("catools.vault.paths"),
    CATOOLS_VAULT_SKIP_LIST("catools.vault.skip_list"),
