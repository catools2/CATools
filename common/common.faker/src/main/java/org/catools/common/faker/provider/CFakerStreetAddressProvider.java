 ...
 *
 * <p>This class generates realistic street addresses by combining random elements from predefined
 * lists of street names, suffixes, prefixes, and number patterns. It uses regex patterns to
 * generate varied street and building numbers.
 *
...
public class CFakerStreetAddressProvider {
   ...
   *
   * <p>This method creates a complete street address by randomly selecting elements from the
   * configured lists and generating numbers based on the provided patterns. Each call returns a
   * new, randomly generated address.
   *
   * <p><strong>Generated components:</strong>
   *
   * <ul>
   *   <li><strong>Street Name:</strong> Randomly selected from the streetNames list
   *   <li><strong>Street Suffix:</strong> Randomly selected from the streetSuffixes list (e.g.,
   *       "St", "Ave", "Blvd")
   *   <li><strong>Street Prefix:</strong> Randomly selected from the streetPrefixes list (e.g.,
   *       "N", "S", "E", "W")
   *   <li><strong>Street Number:</strong> Generated using a random pattern from
   *       streetNumberPatterns
   *   <li><strong>Building Number:</strong> Generated using a random pattern from
   *       buildingNumberPatterns
   * </ul>
   *
   * <p><strong>Example outputs:</strong>
   *
   * <pre>{@code
   * // Example 1:
   ...
   * }</pre>
   *
   * @return a {@link CRandomStreetInfo} object containing randomly generated street address
   *     components
