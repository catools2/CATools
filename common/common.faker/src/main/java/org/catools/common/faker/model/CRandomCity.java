...
/**
 * Represents a random city entity with its basic information including name and zip code. This
 * class is designed to be used in data generation and testing scenarios where city information is
 * needed.
 *
 ...
 *   <li>Default no-argument constructor
 *   <li>All-arguments constructor
 *   <li>equals(), hashCode(), and toString() methods
 *   <li>Fluent setter methods that return 'this' for method chaining
 * </ul>
 *
...
public class CRandomCity {
   ...
   *
   * <p>This field stores the city name as a string. It can contain any valid city name including
   * those with spaces, hyphens, or apostrophes.
   *
   ...
   *
   * <p>This field stores the postal code associated with the city. The format may vary depending on
   * the country, but typically represents a US ZIP code format.
   *
   * <h4>Examples of valid ZIP codes:</h4>
   *
   * <ul>
   *   <li>"10001" - Standard 5-digit US ZIP code
   *   <li>"90210" - Another 5-digit US ZIP code
   *   <li>"12345-6789" - ZIP+4 format (though this implementation uses String, so any format is
   *       supported)
   * </ul>
   *
   * <p><strong>Note:</strong> While this field is typed as String to allow flexibility, it's
   * typically expected to contain numeric ZIP codes for US cities.
   *
   * @see #getZipCode()
