...
public class CCipher {
  public static String decrypt(
      String transformation, String algorithm, String strToDecrypt, String secret) {
    try {
  ...
  public static String encrypt(
      String transformation, String algorithm, String strToEncrypt, String secret) {
    try {
      Cipher cipher = Cipher.getInstance(transformation);
  ...
  private static SecretKeySpec getEncryptionKey(String myKey, String algorithm)
