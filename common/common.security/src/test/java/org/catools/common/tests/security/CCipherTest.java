...
public class CCipherTest extends CBaseUnitTest {
  ...
  private static final String DECRYPTED_STRING =
      "88V7rr/B7oPh00vivqme1XZIbz/r+ZRzOq7LKCnqLeBLcSAp89C/0MVLOZmTKdNS";
  private static final String PASSWORD = "Password for very super top secret information.";

  @Test
  public void testDecrypt() {
    CVerify.String.equals(
        CCipher.decrypt("AES/ECB/PKCS5PADDING", "SHA-1", DECRYPTED_STRING, PASSWORD),
        ORIGINAL_STRING,
  ...
  public void testDecrypt_PasswordIsNull() {
    CVerify.String.equals(
        CCipher.decrypt("AES/ECB/PKCS5PADDING", "SHA-1", DECRYPTED_STRING, null),
        ORIGINAL_STRING,
        "decryption works fine");
  }
  ...
  public void testDecrypt_InputIsNull() {
    CVerify.String.equals(
        CCipher.decrypt("AES/ECB/PKCS5PADDING", "SHA-1", null, PASSWORD),
        ORIGINAL_STRING,
        "decryption works fine");
  }
  ...
  public void testEncrypt() {
    CVerify.String.equals(
        CCipher.encrypt("AES/ECB/PKCS5PADDING", "SHA-1", ORIGINAL_STRING, PASSWORD),
        DECRYPTED_STRING,
  ...
  public void testEncrypt_PasswordIsNull() {
    CVerify.String.equals(
        CCipher.encrypt("AES/ECB/PKCS5PADDING", "SHA-1", ORIGINAL_STRING, null),
        DECRYPTED_STRING,
        "encryption works fine");
  }
  ...
  public void testEncrypt_InputIsNull() {
    CVerify.String.equals(
        CCipher.encrypt("AES/ECB/PKCS5PADDING", "SHA-1", null, PASSWORD),
        DECRYPTED_STRING,
        "encryption works fine");
  }
}
