 ...
 *
 * <p>It happens when you want to remove test from your execution but in large projects it happens
 * that you disable test and then forgot about it. To avoid such situation we have {@link CIgnored}.
 *
 ...
 *
 * <ul>
 *   <li>Always add a comment explaining why the test is ignored
 *   <li>Include a timeline or condition for when the test should be re-enabled
 *   <li>Consider using more specific annotations like {@link COpenDefects} for known issues
 *   <li>Regularly review ignored tests to avoid accumulation of disabled tests
 * </ul>
 *
 * @see CDeferred
 * @see CDefects
