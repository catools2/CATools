...
/**
 * This annotation {@link COpenDefects} is used to link test methods to related open defects. It
 * helps track which tests are expected to fail due to known issues that are still being worked on.
 *
 * <p>This annotation is typically used in test automation frameworks to:
 *
 * <ul>
 *   <li>Document known failures in test cases
 *   <li>Track defect IDs that are preventing tests from passing
 *   <li>Provide traceability between test failures and bug tracking systems
 * </ul>
 *
 * <p><strong>Usage Guidelines:</strong>
 *
 * <ul>
 *   <li>If defect is fixed, remove {@link COpenDefects} and add the fixed defect ID to
 *       {@code @CDefects} annotation instead
 *   <li>If defect is deferred for short term, change {@link COpenDefects} to {@link CDeferred}
 *   <li>Use specific defect IDs from your bug tracking system (e.g., JIRA, GitHub Issues)
 * </ul>
 *
...
public @interface COpenDefects {
   ...
   *
   * <ul>
   *   <li>JIRA ticket IDs (e.g., "PROJ-1234", "BUG-5678")
   *   <li>GitHub issue numbers (e.g., "GH-123", "Issue-456")
   *   <li>Azure DevOps work item IDs (e.g., "ADO-789")
   *   <li>Custom internal defect tracking IDs
   * </ul>
   *
   * <p><strong>Best Practices:</strong>
   *
   * <ul>
   *   <li>Use consistent naming conventions across your project
   *   <li>Include the tracking system prefix for clarity
   *   <li>Keep IDs up-to-date as defects are resolved
   *   <li>Remove this annotation when all referenced defects are fixed
   * </ul>
   *
   * <p><strong>Examples:</strong>
   *
