...
public class CExcelUtilTest {
  ...
  public void testReadXSSFWorksheetWithoutHeader() {
    ...
    CVerify.String.equals(
        header.get(1).getStringCellValue(), "First Name", "Cell Value is correct");
    ...
    CVerify.String.equals(
        firstRecord.get(1).getStringCellValue(), "Dulce", "Cell Value is correct");
    CVerify.Date.equals(
        firstRecord.get(6).getDateCellValue(),
        CDate.of("10/10/1983", "dd/MM/yyyy"),
        "Cell Value is correct");
  }
  ...
  public void testReadXSSFWorksheetWithHeader() {
    ...
    CVerify.Double.equals(
        firstRow.get(0).getHeader().getNumericCellValue(), 0.0, "Cell header is correct");
    CVerify.String.equals(
        firstRow.get(1).getHeader().getStringCellValue(), "First Name", "Cell header is correct");
    CVerify.String.equals(
        firstRow.get(6).getHeader().getStringCellValue(), "Date", "Cell header is correct");
    ...
    CVerify.Date.equals(
        firstRow.get(6).getDateCellValue(),
        CDate.of("10/10/1983", "dd/MM/yyyy"),
        "Cell Value is correct");
  }
}
