 ...
 * @see CList
 */
public interface CMapWaitVerify<K, V>
    extends CMapVerify<K, V>, CObjectWaitVerify<Map<K, V>, CMapState<K, V>> {
  ...
  default void verifyContainsAll(
      Map<K, V> expected, final int waitInSeconds, final String message, final Object... params) {
    verifyContainsAll(
        expected, waitInSeconds, getDefaultWaitIntervalInMilliSeconds(), message, params);
  }
