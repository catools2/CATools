...
public interface CNumberWaitVerifier<N extends Number & Comparable<N>>
  ...
  default void verifyBetweenExclusive(
    ...
    verifyBetweenExclusive(
        verifier, lowerBound, higherBound, waitInSeconds, getDefaultWaitIntervalInMilliSeconds());
  }
  ...
  default void verifyEqualsP(
      ...
      final int waitInSeconds) {
    verifyEqualsP(
        verifier, expected, precision, waitInSeconds, getDefaultWaitIntervalInMilliSeconds());
  }
