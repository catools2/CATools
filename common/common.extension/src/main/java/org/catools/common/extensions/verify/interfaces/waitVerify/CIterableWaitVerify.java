 ...
 *
 * <p>Please Note that we should extend manually {@link CIterableVerification} for each new added
 * verification here
 *
 * @see Map
 * @see CIterable
 ...
 * @see CList
 */
public interface CIterableWaitVerify<E, C extends Iterable<E>>
    extends CIterableVerify<E, C>, CObjectWaitVerify<C, CIterableState<E, C>> {
  ...
  default void verifyContains(
      E expected, final int waitInSeconds, final String message, final Object... params) {
    verifyContains(
   ...
   */
  default void verifyContains(
      E expected, final int waitInSeconds, final int intervalInMilliSeconds) {
    verifyContains(
        expected, waitInSeconds, intervalInMilliSeconds, getDefaultMessage("Contains The Record"));
  }
  ...
  default void verifyContainsAll(
      C expected, final int waitInSeconds, final String message, final Object... params) {
    verifyContainsAll(
        expected, waitInSeconds, getDefaultWaitIntervalInMilliSeconds(), message, params);
  }
   ...
   */
  default void verifyContainsAll(
      C expected, final int waitInSeconds, final int intervalInMilliSeconds) {
    verifyContainsAll(
        expected, waitInSeconds, intervalInMilliSeconds, getDefaultMessage("Contains All"));
  }
  ...
  default void verifyContainsNone(
      C expected, final int waitInSeconds, final int intervalInMilliSeconds) {
    verifyContainsNone(
        expected, waitInSeconds, intervalInMilliSeconds, getDefaultMessage("Contains None"));
  }
  ...
  default void verifyEquals(C expected, final int waitInSeconds, final int intervalInMilliSeconds) {
    verifyEquals(
        expected, waitInSeconds, intervalInMilliSeconds, getDefaultMessage("Records Are Equals"));
  }
