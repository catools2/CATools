...
public interface CStringWaitVerify extends CStringVerify, CObjectWaitVerify<String, CStringState> {
   ...
   */
  default void verifyCenterPadEquals(
      int size, String padStr, final String expected, final int waitInSeconds) {
    verifyCenterPadEquals(
   ...
   */
  default void verifyContains(
      final String expected, final int waitInSeconds, final int intervalInMilliSeconds) {
    verifyContains(
        expected,
        waitInSeconds,
        intervalInMilliSeconds,
  ...
  default void verifyEndsWith(
      String suffix, final int waitInSeconds, final String message, final Object... params) {
  ...
  default void verifyEndsWithAny(
      ...
      final Object... params) {
    verifyEndsWithAny(
        searchInputs, waitInSeconds, getDefaultWaitIntervalInMilliSeconds(), message, params);
  }
  ...
  default void verifyEndsWithIgnoreCase(
    ...
    verifyEndsWithIgnoreCase(
        suffix, waitInSeconds, getDefaultWaitIntervalInMilliSeconds(), message, params);
  }
  ...
  default void verifyEqualsAnyIgnoreCase(
    ...
    verifyEqualsAnyIgnoreCase(
        expectedList, waitInSeconds, getDefaultWaitIntervalInMilliSeconds(), message, params);
  }
  ...
  default void verifyIsAlphanumericSpace(
    ...
    verifyIsAlphanumericSpace(
        waitInSeconds, getDefaultWaitIntervalInMilliSeconds(), message, params);
  }
  ...
  default void verifyMatchesAny(
    ...
    verifyMatchesAny(
        ...
        waitInSeconds,
        intervalInMilliSeconds,
        getDefaultMessage("Value Matches Any Of The Provided Pattern"));
  }
  ...
  default void verifyMatchesAny(
      ...
      final Object... params) {
    verifyMatchesAny(
        patterns, waitInSeconds, getDefaultWaitIntervalInMilliSeconds(), message, params);
  }
  ...
  default void verifyMatchesNone(
    ...
    verifyMatchesNone(
        ...
        waitInSeconds,
        intervalInMilliSeconds,
        getDefaultMessage("Value Matches None Of The Provided Pattern"));
  }
   ...
   */
  default void verifyMatches(
      final String pattern, final int waitInSeconds, final String message, final Object... params) {
    verifyMatches(pattern, waitInSeconds, getDefaultWaitIntervalInMilliSeconds(), message, params);
  }
  ...
  default void verifyIsNotBlank(final int waitInSeconds, final int intervalInMilliSeconds) {
    verifyIsNotBlank(
        waitInSeconds, intervalInMilliSeconds, getDefaultMessage("Value Is Not Blank"));
  }
  ...
  default void verifyIsNotEmpty(final int waitInSeconds, final int intervalInMilliSeconds) {
    verifyIsNotEmpty(
        waitInSeconds, intervalInMilliSeconds, getDefaultMessage("Value Is Not Empty"));
  }
  ...
  default void verifyNotMatches(
      ...
      final Object... params) {
    verifyNotMatches(
        pattern, waitInSeconds, getDefaultWaitIntervalInMilliSeconds(), message, params);
  }
  ...
  default void verifyLeftValueEquals(
    ...
    verifyLeftValueEquals(
        len, expected, waitInSeconds, getDefaultWaitIntervalInMilliSeconds(), message, params);
  }
   ...
   */
  default void verifyLeftValueEquals(
      int len, final String expected, final int waitInSeconds, final int intervalInMilliSeconds) {
    verifyLeftValueEquals(
        len,
        expected,
        waitInSeconds,
  ...
  default void verifyMidValueEquals(
    ...
    verifyMidValueEquals(
        pos, len, expected, waitInSeconds, getDefaultWaitIntervalInMilliSeconds(), message, params);
  }
   ...
   */
  default void verifyMidValueEquals(
      int pos, int len, final String expected, final int waitInSeconds) {
  ...
  default void verifyRemoveEndEquals(
    ...
    verifyRemoveEndEquals(
        remove, expected, waitInSeconds, getDefaultWaitIntervalInMilliSeconds(), message, params);
  }
   ...
   */
  default void verifyRemoveEndEquals(
      String remove, final String expected, final int waitInSeconds) {
   ...
   */
  default void verifyReplaceEquals(
      String searchString, String replacement, final String expected, final int waitInSeconds) {
    verifyReplaceEquals(
   ...
   */
  default void verifyStripedEndValue(
      String stripChars, final String expected, final int waitInSeconds) {
    verifyStripedEndValue(
   ...
   */
  default void verifySubstringAfterEquals(
      String separator, final String expected, final int waitInSeconds) {
    verifySubstringAfterEquals(
   ...
   */
  default void verifySubstringBetweenEquals(
      String open, String close, final String expected, final int waitInSeconds) {
    verifySubstringBetweenEquals(
  ...
  default void verifySubstringEquals(
    ...
    verifySubstringEquals(
        start, expected, waitInSeconds, getDefaultWaitIntervalInMilliSeconds(), message, params);
  }
   ...
   */
  default void verifySubstringEquals(
      int start, final String expected, final int waitInSeconds, final int intervalInMilliSeconds) {
    verifySubstringEquals(
        start,
        expected,
        waitInSeconds,
   ...
   */
  default void verifySubstringEquals(
      int start, int end, final String expected, final int waitInSeconds) {
    verifySubstringEquals(
  ...
  default void verifyTruncatedValueEquals(
    ...
    verifyTruncatedValueEquals(
        maxWidth, expected, waitInSeconds, getDefaultWaitIntervalInMilliSeconds(), message, params);
  }
   ...
   */
  default void verifyTruncatedValueEquals(
      int maxWidth, final String expected, final int waitInSeconds) {
    verifyTruncatedValueEquals(
