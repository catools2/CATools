...
public interface CFileWaitVerifier extends CFileVerifier, CObjectWaitVerifier<File, CFileState> {
  ...
  default void verifyEqualsStringContent(
      final CVerificationQueue verifier, final File expectedFile, final int waitInSeconds) {
  ...
  default void verifyIsNotExists(
      ...
      final int intervalInMilliSeconds) {
    verifyIsNotExists(
        verifier, waitInSeconds, intervalInMilliSeconds, getDefaultMessage("Does Not Exist"));
  }
  ...
  default void verifyNotEqualsStringContent(
      final CVerificationQueue verifier, final CFile expectedFile, final int waitInSeconds) {
