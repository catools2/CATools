 ...
 */
public interface CNumberWaitVerify<N extends Number & Comparable<N>>
    extends CNumberVerify<N>, CObjectWaitVerify<N, CNumberState<N>> {
  ...
  default void verifyGreater(
      final N expected, final int waitInSeconds, final String message, final Object... params) {
