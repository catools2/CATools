 ...
 */
public interface CIterableWaitVerifier<E, C extends Iterable<E>>
    extends CIterableVerifier<E, C>, CObjectWaitVerifier<C, CIterableState<E, C>> {
  ...
  default void verifyHas(final CVerificationQueue verifier, Predicate<E> expected) {
    verifyHas(
        verifier, expected, getDefaultWaitInSeconds(), getDefaultWaitIntervalInMilliSeconds());
  }
  ...
  default void verifyNotContainsAll(
      final CVerificationQueue verifier, C expected, final int waitInSeconds) {
