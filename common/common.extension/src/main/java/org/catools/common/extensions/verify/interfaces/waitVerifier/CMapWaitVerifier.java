...
public interface CMapWaitVerifier<K, V>
  ...
  default void verifyContains(
      CVerificationQueue verifier, K expectedKey, V expectedValue, final int waitInSeconds) {
    verifyContains(
        verifier,
   ...
   */
  default void verifyContains(
      final CVerificationQueue verifier, Map.Entry<K, V> expected, final int waitInSeconds) {
  ...
  default void verifyContains(
    ...
    verifyContains(
        verifier, Map.entry(expectedKey, expectedValue), waitInSeconds, intervalInMilliSeconds);
  }
  ...
  default void verifyContainsAll(
      final CVerificationQueue verifier, Map<K, V> expected, final int waitInSeconds) {
  ...
  default void verifyIsNotEmpty(
      CVerificationQueue verifier, final int waitInSeconds, final int intervalInMilliSeconds) {
    verifyIsNotEmpty(
        verifier, waitInSeconds, intervalInMilliSeconds, getDefaultMessage("Is Not Empty"));
  }
  ...
  default void verifySizeIsGreaterThan(
      final CVerificationQueue verifier, int expected, final int waitInSeconds) {
