...
public interface CNumberVerifier<N extends Number & Comparable<N>>
    extends CBaseNumberExtension<N>, CObjectVerifier<N, CNumberState<N>> {
  ...
  default void verifyEqualsP(
    ...
    verifyEqualsP(
        verifier, expected, precision, getDefaultMessage("Is Equal To The Expected Value"));
  }
  ...
  default void verifyGreaterOrEqual(final CVerificationQueue verifier, final N expected) {
    verifyGreaterOrEqual(
        verifier, expected, getDefaultMessage("Is Greater Than Or Equal To The Expected Value"));
  }
  ...
  default void verifyLessOrEqual(final CVerificationQueue verifier, final N expected) {
    verifyLessOrEqual(
        verifier, expected, getDefaultMessage("Is Less Than Or Equal To The Expected Value"));
  }
