...
public class CFileWaitVerifyTest extends CBaseWaitVerifyTest {
  ...
  public void testNotExists() {
    verify(
        verifier ->
            toWaitVerifier(getPath("testNotExists", "anything") + "1").verifyIsNotExists(verifier));
    verify(
        verifier ->
            toWaitVerifier(getPath("testNotExists", "anything") + "1")
                .verifyIsNotExists(verifier, 1));
  }
  ...
  public void testEquals() {
    ...
    verify(
        verifier ->
            toWaitVerifier(getPath("testEquals", paragraphs))
  ...
  public void testExistsWhenNot() {
    ...
    verify(
        verifier ->
            toWaitVerifier(getPath("testExistsWhenNot", paragraphs) + "Invalid")
                .verifyExists(verifier, 1));
  }
  ...
  public void testNotExistsWhenIs() {
    ...
    verify(
        verifier ->
            toWaitVerifier(getPath("testExistsWhenNot", paragraphs))
                .verifyIsNotExists(verifier, 1));
  }
  ...
  public void testEqualsWhenNoDest() {
    ...
    verify(
        verifier ->
            toWaitVerifier(getPath("testEquals1WhenNoDest1", paragraphs))
        ...
        verifier ->
            toWaitVerifier(
                    new CFile(getPath("testEquals1WhenNoDest1", paragraphs) + "Invalid")
                        .getCanonicalPath())
                .verifyEqualsStringContent(
                    verifier, getFile("testEquals1WhenNoDest12", paragraphs)));
  }
  ...
  public void testEqualsWhenNotEqual() {
    ...
    verify(
        verifier ->
            toWaitVerifier(getPath("testEquals1WhenNotEqual1", paragraphs))
                .verifyEqualsStringContent(
                    verifier, getFile("testEquals1WhenNotEqual12", paragraphs + "1"), 0, 100));
  }
  ...
  public void testNotEquals() {
    ...
    verify(
        verifier ->
            toWaitVerifier(path)
                .verifyNotEqualsStringContent(verifier, getFile("testNotEquals2", paragraphs)));
    verify(
        verifier ->
            toWaitVerifier(path)
                .verifyNotEqualsStringContent(verifier, getFile("testNotEquals2", paragraphs), 1));
  }
  ...
  public void testNotEquals_NoDest() {
    ...
    verify(
        verifier ->
            toWaitVerifier(getPath("testNotEquals_NoDest", paragraphs + "1"))
        ...
        verifier ->
            toWaitVerifier(
                    new CFile(getPath("testNotEquals_NoSrc", paragraphs + "1") + "Invalid")
                        .getCanonicalPath())
                .verifyNotEqualsStringContent(
                    verifier, getFile("testNotEquals_NoSrc2", paragraphs), 1));
  }
  ...
  public void testNotEquals_NotEqual() {
    ...
    verify(
        verifier ->
            toWaitVerifier(getPath("testNotEquals_NotEqual", paragraphs))
                .verifyNotEqualsStringContent(
                    verifier, getFile("testNotEquals_NotEqual2", paragraphs), 1));
  }
