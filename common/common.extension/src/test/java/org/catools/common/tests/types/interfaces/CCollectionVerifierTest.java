...
public class CCollectionVerifierTest extends CBaseUnitTest {
  ...
  public void testVerifyHas() {
    new CList<>("A", "B", "D", "C")
        .verifyHas(s -> s.equals("D"), "CCollectionTest ::> verifyContains");
  }

  @Test(retryAnalyzer = CTestRetryAnalyzer.class)
  public void testVerifyHas1() {
    CVerifier verifier = new CVerifier();
    verifier.Collection.has(
        new CList<>("A", "B", "D", "C"), s -> s.equals("D"), "CCollectionTest ::> verifyContains");
    verifier.verify();
  }
  ...
  public void testVerifyHas1_N() {
    CVerifier verifier = new CVerifier();
    verifier.Collection.has(
        new CList<>("A", "B", "D", "C"), s -> s.equals("x"), "CCollectionTest ::> verifyContains");
    verifier.verify();
  }
  ...
  public void testVerifyContains1() {
    ...
    verifier.Collection.contains(
        new CList<>("A", "B", "D", "C"), "D", "CCollectionTest ::> verifyContains");
    verifier.verify();
  }
  ...
  public void testVerifyContains1_N() {
    CVerifier verifier = new CVerifier();
    verifier.Collection.contains(
        new CList<>("A", "B", "D", "C"), "X", "CCollectionTest ::> verifyContains");
    verifier.verify();
  }
  ...
  public void testVerifyContainsAll() {
    new CList<>("A", "B", "D", "C")
        .verifyContainsAll(new CSet<>("A", "B", "B"), "CCollectionTest ::> verifyContainsAll");
  }

  @Test(retryAnalyzer = CTestRetryAnalyzer.class)
  public void testVerifyContainsAll1() {
    CVerifier verifier = new CVerifier();
    verifier.Collection.containsAll(
        new CSet<>("A", "B", "D", "C"),
        new CList<>("A", "B", "B"),
        "CCollectionTest ::> verifyContainsAll");
    verifier.verify();
  }
  ...
  public void testVerifyContainsAll_N() {
    new CList<>("A", "B", "D", "C")
        .verifyContainsAll(new CSet<>("A", "B", "X"), "CCollectionTest ::> verifyContainsAll");
  }

  @Test(retryAnalyzer = CTestRetryAnalyzer.class)
  public void testVerifyContainsNone() {
    new CList<>("A", "B", "D", "C")
        .verifyContainsNone(new CSet<>("Z", "X"), "CCollectionTest ::> verifyContainsNone");
  }

  @Test(retryAnalyzer = CTestRetryAnalyzer.class)
  public void testVerifyContainsNone1() {
    CVerifier verifier = new CVerifier();
    verifier.Collection.containsNone(
        new CList<>("A", "B", "D", "C"),
        new CSet<>("Z", "X"),
        "CCollectionTest ::> verifyContainsNone");
    verifier.verify();
  }
  ...
  public void testVerifyContainsNone_N() {
    new CList<>("A", "B", "D", "C")
        .verifyContainsNone(new CSet<>("A", "B"), "CCollectionTest ::> verifyContainsNone");
  }
  ...
  public void testVerifyEmptyOrContains() {
    new CList<>("A", "B", "D", "C")
        .verifyEmptyOrContains("C", "CCollectionTest ::> verifyEmptyOrContains");
  }

  @Test(retryAnalyzer = CTestRetryAnalyzer.class)
  public void testVerifyEmptyOrContains1() {
    CVerifier verifier = new CVerifier();
    verifier.Collection.emptyOrContains(
        new CList<>("A", "B", "D", "C"), "D", "CCollectionTest ::> verifyEmptyOrContains");
    verifier.verify();
  }
  ...
  public void testVerifyEmptyOrContains1_N() {
    CVerifier verifier = new CVerifier();
    verifier.Collection.emptyOrContains(
        new CList<>("A", "B", "D", "C"), "X", "CCollectionTest ::> verifyEmptyOrContains");
    verifier.verify();
  }
  ...
  public void testVerifyEmptyOrContains2_N() {
    CVerifier verifier = new CVerifier();
    verifier.Collection.emptyOrContains(
        new CList<>("A", "B", "D", "C"), null, "CCollectionTest ::> verifyEmptyOrContains");
    verifier.verify();
  }
  ...
  public void testVerifyEmptyOrContains_N() {
    new CList<>("A", "B", "D", "C")
        .verifyEmptyOrContains("X", "CCollectionTest ::> verifyEmptyOrContains");
  }

  @Test(retryAnalyzer = CTestRetryAnalyzer.class)
  public void testVerifyEmptyOrNotContains() {
    new CList<>("A", "B", "D", "C")
        .verifyEmptyOrNotContains("X", "CCollectionTest ::> verifyEmptyOrNotContains");
  }

  @Test(retryAnalyzer = CTestRetryAnalyzer.class)
  public void testVerifyEmptyOrNotContains1() {
    CVerifier verifier = new CVerifier();
    verifier.Collection.emptyOrNotContains(
        new CList<>("A", "B", "D", "C"), "Y", "CCollectionTest ::> verifyEmptyOrNotContains");
    verifier.verify();
  }
  ...
  public void testVerifyEmptyOrNotContains1_N() {
    CVerifier verifier = new CVerifier();
    verifier.Collection.emptyOrNotContains(
        new CList<>("A", "B", "D", "C"), "C", "CCollectionTest ::> verifyEmptyOrNotContains");
    verifier.verify();
  }
  ...
  public void testVerifyEmptyOrNotContains_N() {
    new CList<>("A", "B", "D", "C")
        .verifyEmptyOrNotContains("D", "CCollectionTest ::> verifyEmptyOrNotContains");
  }

  @Test(retryAnalyzer = CTestRetryAnalyzer.class)
  public void testVerifyEquals() {
    new CList<>("A", "B", "D", "C")
        .verifyEquals(new CSet<>("A", "B", "C", "D"), "CCollectionTest ::> verifyEquals");
  }

  @Test(retryAnalyzer = CTestRetryAnalyzer.class)
  public void testVerifyEquals1() {
    CVerifier verifier = new CVerifier();
    verifier.Collection.equals(
        new CList<>("A", "B", "D", "C"),
        new CSet<>("A", "B", "C", "D"),
        "CCollectionTest ::> verifyEquals");
    verifier.verify();
  }
  ...
  public void testVerifyEquals_N() {
    new CList<>("A", "B", "D", "C")
        .verifyEquals(new CSet<>("A", "B", "X", "D"), "CCollectionTest ::> verifyEquals");
  }
  ...
  public void testVerifyIsNotEmpty1() {
    CVerifier verifier = new CVerifier();
    verifier.Collection.isNotEmpty(
        new CList<>("A", "B", "D", "C"), "CCollectionTest ::> verifyIsNotEmpty");
    verifier.verify();
  }
  ...
  public void testVerifyNotContains1() {
    ...
    verifier.Collection.notContains(
        new CList<>("A", "B", "D", "C"), "X", "CCollectionTest ::> verifyNotContains");
    verifier.verify();
  }
  ...
  public void testVerifyNotContains1_N() {
    CVerifier verifier = new CVerifier();
    verifier.Collection.notContains(
        new CList<>("A", "B", "D", "C"), "C", "CCollectionTest ::> verifyNotContains");
    verifier.verify();
  }
  ...
  public void testVerifyNotContainsAll() {
    new CList<>("A", "B", "D", "C")
        .verifyNotContainsAll(
            new CSet<>("A", "B", "X"), "CCollectionTest ::> verifyNotContainsAll");
  }

  @Test(retryAnalyzer = CTestRetryAnalyzer.class)
  public void testVerifyNotContainsAll1() {
    CVerifier verifier = new CVerifier();
    verifier.Collection.notContainsAll(
        new CSet<>("A", "B", "D", "C"),
        new CList<>("A", "B", "X"),
        "CCollectionTest ::> verifyNotContainsAll");
    verifier.verify();
  }
  ...
  public void testVerifyNotContainsAll_N() {
    new CList<>("A", "B", "D", "C")
        .verifyNotContainsAll(
            new CSet<>("A", "B", "C"), "CCollectionTest ::> verifyNotContainsAll");
  }
  ...
  public void testVerifySizeEquals1() {
    CVerifier verifier = new CVerifier();
    verifier.Collection.verifySizeEquals(
        new CList<>("A", "B", "D", "C"), 4, "CCollectionTest ::> verifySizeEquals");
    verifier.Collection.verifySizeEquals(
        new CSet<>("A", "B", "B", "C"), 3, "CCollectionTest ::> verifySizeEquals");
    verifier.verify();
  }
  ...
  public void testVerifySizeIsGreaterThan() {
    new CList<>("A", "B", "D", "C")
        .verifySizeIsGreaterThan(3, "CCollectionTest ::> verifySizeIsGreaterThan");
    new CSet<>("A", "B", "B", "C")
        .verifySizeIsGreaterThan(2, "CCollectionTest ::> verifySizeIsGreaterThan");
  }

  @Test(retryAnalyzer = CTestRetryAnalyzer.class)
  public void testVerifySizeIsGreaterThan1() {
    CVerifier verifier = new CVerifier();
    verifier.Collection.verifySizeIsGreaterThan(
        new CList<>("A", "B", "D", "C"), 3, "CCollectionTest ::> verifySizeIsGreaterThan");
    verifier.Collection.verifySizeIsGreaterThan(
        new CSet<>("A", "B", "B", "C"), 2, "CCollectionTest ::> verifySizeIsGreaterThan");
    verifier.verify();
  }
  ...
  public void testVerifySizeIsLessThan() {
    new CList<>("A", "B", "D", "C")
        .verifySizeIsLessThan(5, "CCollectionTest ::> verifySizeIsLessThan");
    new CSet<>("A", "B", "B", "C")
        .verifySizeIsLessThan(4, "CCollectionTest ::> verifySizeIsLessThan");
  }

  @Test(retryAnalyzer = CTestRetryAnalyzer.class)
  public void testVerifySizeIsLessThan1() {
    CVerifier verifier = new CVerifier();
    verifier.Collection.verifySizeIsLessThan(
        new CList<>("A", "B", "D", "C"), 5, "CCollectionTest ::> verifySizeIsLessThan");
    verifier.Collection.verifySizeIsLessThan(
        new CSet<>("A", "B", "B", "C"), 4, "CCollectionTest ::> verifySizeIsLessThan");
    verifier.verify();
  }
}
