 ...
 * for managing {@link CZScaleChangeHistory} objects. It includes constructors for
...
public class CZScaleChangeHistories extends CSet<CZScaleChangeHistory> {
   ...
   * Default constructor.
   *
   * <p>Creates an empty collection of Scale change histories.</p>
   */
   ...
   *
   * @param stream a {@link Stream} of {@link CZScaleChangeHistory} objects to initialize the collection
   */
   ...
   *
   * @param iterable an {@link Iterable} of {@link CZScaleChangeHistory} objects to initialize the collection
   */
