 ...
 * for managing {@link CZScaleTestResult} objects. It includes constructors
...
public class CZScaleTestResults extends CSet<CZScaleTestResult> {
   ...
   * Default constructor.
   *
   * <p>Creates an empty collection of test results.</p>
   */
   ...
   *
   * @param stream a {@link Stream} of {@link CZScaleTestResult} objects to initialize the collection
   */
   ...
   *
   * @param iterable an {@link Iterable} of {@link CZScaleTestResult} objects to initialize the collection
   */
