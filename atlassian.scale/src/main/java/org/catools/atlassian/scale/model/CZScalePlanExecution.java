 ...
 *
 * <p>This class models the execution of a test case within a Scale plan, including information such
 * as the test case key, execution status, environment, user details, execution time, and custom
 * fields. It supports JSON serialization/deserialization and uses custom serializers/deserializers
 * for date handling.
 */
@Data
@NoArgsConstructor
