 ...
 * for managing {@link CZScalePlanExecution} objects. It includes constructors
...
public class CZScalePlanExecutions extends CSet<CZScalePlanExecution> {
   ...
   * Default constructor.
   *
   * <p>Creates an empty collection of Scale plan executions.</p>
   */
   ...
   *
   * @param stream a {@link Stream} of {@link CZScalePlanExecution} objects to initialize the collection
   */
   ...
   *
   * @param iterable an {@link Iterable} of {@link CZScalePlanExecution} objects to initialize the collection
   */
