 ...
 * Scale-related configuration properties via the {@link CHocon} helper.</p>
 *
 * <p>All methods delegate to {@link CHocon} using well-known configuration paths defined
 * in the {@link Scale.Configs} enum.</p>
 */
@UtilityClass
public class CZScaleConfigs {
   ...
   *
   * <p>All methods in this utility return values from the application's configuration
   * store. Values are obtained using {@link CHocon} and the paths defined in
   * {@link Configs}.</p>
   */
  @UtilityClass
  public static class Scale {
     ...
     *
     * <p>Each constant represents a configuration key path that maps to a property consumed
     * by the Scale integration. The {@link #path} value is returned from the enum's
     * {@link CHoconPath} implementation (provided via Lombok {@code @Getter}).</p>
     */
    @Getter
    @AllArgsConstructor
    private enum Configs implements CHoconPath {
      /**
       * Configuration path for the Scale service base URL.
       * Property key: {@code catools.atlassian.scale.home}
       */
      CATOOLS_ATLASSIAN_SCALE_HOME("catools.atlassian.scale.home"),

      /**
       * Configuration path for the Scale ATM endpoint URL.
       * Property key: {@code catools.atlassian.scale.atm}
       */
      CATOOLS_ATLASSIAN_SCALE_ATM("catools.atlassian.scale.atm"),

      /**
       * Configuration path for the Scale tests endpoint URL.
       * Property key: {@code catools.atlassian.scale.tests}
       */
      CATOOLS_ATLASSIAN_SCALE_TESTS("catools.atlassian.scale.tests"),

      /**
       * Configuration path for the Scale username used for authentication.
       * Property key: {@code catools.atlassian.scale.username}
       */
      CATOOLS_ATLASSIAN_SCALE_USERNAME("catools.atlassian.scale.username"),

      /**
       * Configuration path for the Scale password used for authentication.
       * Property key: {@code catools.atlassian.scale.password}
       */
      CATOOLS_ATLASSIAN_SCALE_PASSWORD("catools.atlassian.scale.password"),

      /**
       * Configuration path for the list of accepted date formats in Scale.
       * Property key: {@code catools.atlassian.scale.date_format}
       */
      CATOOLS_ATLASSIAN_SCALE_DATE_FORMAT("catools.atlassian.scale.date_format"),

      /**
       * Configuration path for the active folder used by Scale.
       * Property key: {@code catools.atlassian.scale.active_folder}
       */
      CATOOLS_ATLASSIAN_SCALE_ACTIVE_FOLDER("catools.atlassian.scale.active_folder"),

      /**
       * Configuration path for the delay between API calls to Scale in milliseconds.
       * Property key: {@code catools.atlassian.scale.delay_between_calls_in_millisecond}
       */
      CATOOLS_ATLASSIAN_SCALE_DELAY_BETWEEN_CALLS_IN_MILLI("catools.atlassian.scale.delay_between_calls_in_millisecond"),

      /**
       * Configuration path for the search buffer size (pagination) for Scale queries.
       * Property key: {@code catools.atlassian.scale.search_buffer_size}
       */
